! function(t, e, a) {
    ...
    var n, i, s = t(e),
        ...
        M = !(!e.nectarOptions || !e.nectarOptions.smooth_scroll || "true" !== e.nectarOptions.smooth_scroll),
        W = !(!e.nectarOptions || !e.nectarOptions.body_border_func || "vignette" != e.nectarOptions.body_border_func),
        B = !(!e.nectarOptions || !e.nectarOptions.body_border_mobile || "1" !== e.nectarOptions.body_border_mobile),
    ...
    f.length > 0 && ("#ffffff" == f.css("background-color") && "light" == r.attr("data-header-color") || "rgb(255, 255, 255)" == f.css("background-color") && "light" == r.attr("data-header-color") || f.css("background-color") == d.attr("data-user-set-bg")) && (pt = !0);
    var vt = navigator.userAgent.match(/(iPod|iPhone|iPad)/) || navigator.userAgent.match(/Mac/) && navigator.maxTouchPoints && navigator.maxTouchPoints > 2;
    (navigator.userAgent.indexOf("Safari") > -1 && navigator.userAgent.indexOf("Chrome") < 1 || vt) && (M = !1);
    var bt = {
        ...
        getWindowSize: function() {
            bt.winH = e.innerHeight, bt.winW = e.innerWidth, bt.adminBarHeight = u.length > 0 ? u.height() : 0, bt.secondaryHeaderHeight = c.length > 0 && "none" != c.css("display") ? c.outerHeight() : 0, bt.footerOuterHeight = m.length > 0 ? m.outerHeight() : 0
        },
        scrollTop: 0,
        clientX: 0,
        clientY: 0,
        ...
        scrollPosRAF: function() {
            bt.scrollTop = e.scrollY || s.scrollTop(), requestAnimationFrame(bt.scrollPosRAF)
        },
        bindEvents: function() {
            bt.usingMobileBrowser || (M || s.on("scroll", function() {
                bt.scrollTop = bt.scrollPosMouse()
            }), a.addEventListener("mousemove", function(t) {
                bt.clientX = t.clientX, bt.clientY = t.clientY
            })), s.on("resize", bt.getWindowSize), e.addEventListener("orientationchange", bt.getWindowSize)
        },
        init: function() {
            u = t("#wpadminbar"), this.getWindowSize(), this.usingPhoneBrowser = !!(bt.usingMobileBrowser && bt.winW < 690), this.scrollTop = this.scrollPosMouse(), this.bindEvents(), this.usingFrontEndEditor = void 0 !== e.vc_iframe
        }
    };
    ...
    function _t() {
        Ve(), bt.usingMobileBrowser || Ye(), In(), qa(), t("#header-outer .sf-menu > li:not(.megamenu) > ul > li > ul").each(function() {
    ...
    function xt() {
        Ae(), Ve(), Wt(), Ea(), f && (F = f.height()), bt.usingMobileBrowser || Ye()
    }
            ...
            if (t().flexslider) {
                ...
                imagesLoaded(t(this), function() {
                    ...
                    a.flexslider({
                        ...
                        touch: !0,
                        slideshow: n
                    }), t(".flex-gallery .flex-direction-nav li a.flex-next").html('<i class="fa fa-angle-right"></i>'), t(".flex-gallery .flex-direction-nav li a.flex-prev").html('<i class="fa fa-angle-left"></i>'), t(e).trigger("salient-parallax-bg-recalculate"), Fe()
                })
            }
        })
    }
    ...
    function Tt() {
        t('.wpb_gallery_slidesflickity_static_height_style .cell[data-lazy="true"]').each(function() {
            ...
            var e = parseInt(t(this).find("img").attr("height")),
                a = Qt(parseInt(t(this).find("img").attr("width")), e, 2e3, parseInt(t(this).find("img").height())),
    ...
    function It() {
        t('.wpb_gallery_slidesflickity_static_height_style .cell[data-lazy="true"]').length > 0 && (Tt(), s.on("smartresize", Tt))
    }

    function Et() {
        if (0 == t(".nectar-flickity:not(.masonry)").length) return !1;
        j = [], Y = [], t(".nectar-flickity:not(.masonry)").each(function(e) {
            j.push(new Ot(t(this), e))
        }), t(".nectar-carousel.nectar-flickity:not(.masonry)").length > 0 && (bt.usingMobileBrowser ? e.addEventListener("orientationchange", zt) : s.on("resize", zt))
    }
    ...
    function At() {
        t("nav:not(.left-side):not(.right-side) .sf-menu > .nectar-megamenu-menu-item.align-left:not(.width-100)").each(function() {
            ...
            if (e) {
                if (n.width() + e.offset().left > bt.winW) return t(this).addClass("align-middle"), !0;
                t(this).find("> ul.sub-menu, > .nectar-global-section-megamenu").css({
    ...
    function Mt() {
        ...
        t("header#top nav:not(.left-side):not(.right-side) > ul > li.megamenu:not(.width-50):not(.width-75) > .sub-menu, header#top nav:not(.left-side):not(.right-side) > ul > li.megamenu:not(.width-50):not(.width-75) > .nectar-global-section-megamenu").css({
    ...
    function Wt() {
        bt.winW < 1e3 && "1" == r.attr("data-responsive") ? (r.addClass("mobile"), t("header#top nav").css("display", "none")) : (r.removeClass("mobile"), t("header#top nav").css("display", ""), t(".slide-out-widget-area-toggle #toggle-nav .lines-button").removeClass("close"))
    }
    ...
    function Pt() {
        ...
        }), J = [], t(".nectar-woo-flickity").each(function(e) {
    ...
    function Yt() {
        ...
        }), s.off("smartresize.clientsCarouselHeight", Rt), s.on("smartresize.clientsCarouselHeight", Rt))
    }
    ...
    function Gt() {
        var e;
        if (r.is('[data-header-format="left-header"]') && bt.winW >= 1e3 || r.is('[data-hhun="1"]') || t(".page-template-template-no-header-footer").length > 0 || t(".page-template-template-no-header").length > 0) e = 0;
        else if (!0 === E) e = t("#header-outer").outerHeight() + parseInt(t("#header-outer").css("margin-top"));
        else {
            var a = y - y / 1.8,
                n = d.outerHeight();
            (c.length > 0 && r.is(".material") || c.length > 0 && !r.is(".material") && bt.winW < 1e3) && (n -= bt.secondaryHeaderHeight), e = d.is('[data-header-resize="1"]') && !d.is(".small-nav") && bt.winW >= 1e3 ? n - (parseInt(_) + 2 * a) : n
        }
        if (bt.winW >= 1e3 && t('#header-outer[data-condense="true"]').length > 0) {
            ...
            e = d.height() - (parseInt(i.position().top) - parseInt(d.find("#logo").css("margin-top"))) - parseInt(bt.secondaryHeaderHeight)
        }
        return e
    }
    ...
    function Jt() {
        bt.usingMobileBrowser || (this.state = {
            ocmFocus: !1
    ...
    function ee(t, n, i) {
        var s = e.scrollY || a.documentElement.scrollTop,
            ...
            o = Math.max(.1, Math.min(Math.abs(s - t) / 1300, 1.3)),
            l = {
    ...
    e.nectarState = yt, $t.prototype.setup = function() {
            ...
            if ("horizontal-movement" === this.iconType) e.$el.is('[data-indicator-blur="true"]') && e.$dragEl.addClass("blurred-bg"), e.$el.find(".flickity-viewport").on("mouseenter", function() {
                ...
                e.$el.is("a") && (r = e.$el), r.off(), r.on("mouseenter", function() {
                    ...
                    e.$el.is("a") ? (e.$viewEl.removeClass("visible"), e.$viewEl.removeClass("blurred-bg")) : e.timeout = setTimeout(function() {
            ...
            this.lastY = Dt(this.lastY, bt.clientY, this.lerpDamp), this.lastX = Dt(this.lastX, bt.clientX, this.lerpDamp)
        }, $t.prototype.parallaxIcon = function() {
            this.parallaxLastX = Dt(this.parallaxLastX, parseInt(bt.clientX) - parseInt(this.lastX), this.lerpDamp) / 1.65, this.parallaxLastY = Dt(this.parallaxLastY, parseInt(bt.clientY) - parseInt(this.lastY), this.lerpDamp) / 1.65, this.$innerParallaxEl.length > 0 && (this.$innerParallaxEl[0].style.transform = "translateX(" + Nt(this.parallaxLastX, 12, -12) + "px) translateY(" + Nt(this.parallaxLastY, 12, -12) + "px)")
            ...
            if (this.fullWidthOverlow(), this.$el.is('[data-format="fixed_text_content_fullwidth"]') && (this.$flickCellAlign = "left", this.$groupCellsBool = !1, this.$flickContainBool = !1, this.$flcikAttr = .02, this.$el.parent().is('[data-alignment="right"]') && (this.$flickCellAlign = "right")), 1 == this.$freeScrollBool && (this.$groupCellsBool = !1), this.$el.find(".nectar-el-parallax-scroll").length > 0 && this.$el.parents('[class*="wpb_gallery_slidesflickity_"]').length > 0 && (this.$groupCellsBool = !1), "next_prev_arrows" == a || "next_prev_arrows_overlaid" == a ? (this.$paginationBool = !1, this.$nextPrevArrowBool = !0) : (this.$paginationBool = !0, this.$nextPrevArrowBool = !1), "none" == a && (this.$paginationBool = !1, this.$nextPrevArrowBool = !1), this.$wrapAround = !this.$el.is("[data-wrap]") || "no-wrap" != this.$el.attr("data-wrap"), this.ticker = !!this.$el.is(".ticker-rotate"), this.tickerPaused = !1, this.ticker) {
                var n = this.$el.is("[data-ticker-speed]") ? this.$el.attr("data-ticker-speed") : "slow",
                    i = this.$el.is("[data-ticker-direction]") ? this.$el.attr("data-ticker-direction") : "default";
                this.tickerSpeed = "slow" === n ? .4 : "medium" === n ? 1.2 : 2, "reverse" === i && (this.tickerSpeed = -1 * this.tickerSpeed), this.$wrapAround = !0, this.$paginationBool = !1
            }
            ...
            !bt.usingFrontEndEditor && ! function() {
                if (-1 != navigator.userAgent.indexOf("Instagram")) return !0;
                return !1
            }() && "IntersectionObserver" in e && !s && !1 === mt.$usingFullScreenRows ? this.lazyInit() : this.init()
            ...
            this.$el.hasClass("nectar-simple-slider") ? this.simpleSliderStyle() : (this.$el.is('.nectar-carousel[data-wrap="no-wrap"]') && this.$el.find('.nectar-fancy-box[data-n-parallax-bg="true"]').length > 0 && !0 !== this.$groupCellsBool || this.$el.parents('[class*="wpb_gallery_slidesflickity_"]').length > 0 && this.$el.find(".nectar-el-parallax-scroll").length > 0) && this.galleryParallax(), (this.$el.is('[data-controls="touch_total"]') || this.$el.is('[data-touch-indicator="true"]')) && this.visualizedTotalControls(), this.$el.is('[data-format="fixed_text_content_fullwidth"]') && !bt.usingFrontEndEditor && this.fixedContentStyle(), this.$el.parents(".wpb_gallery_slidesflickity_static_height_style").length > 0 && this.$el.find(".item-meta").length > 0 && (this.imageCaptionWidth(), s.on("resize", this.imageCaptionWidth.bind(this))), this.ticker && ("IntersectionObserver" in e && this.trackView(), this.tickerRotate(), this.instance.on("dragStart", function() {
                ...
                this.tickerPaused = !1
            }.bind(this)), (this.$el.is('[data-pause-on-hover="true"]') || this.$nextPrevArrowBool || bt.usingFrontEndEditor) && this.$el[0].addEventListener("mouseenter", function() {
                this.tickerPaused = !0
            ...
            !bt.usingFrontEndEditor && "IntersectionObserver" in e ? this.lazyInit() : this.init()
            ...
            if (e.nectarOptions && e.nectarOptions.woo_related_upsell_carousel && "true" == e.nectarOptions.woo_related_upsell_carousel && this.$el.hasClass("related-upsell-carousel") && (h = !0, s = !1, o = !0, "center" == c && this.$el.find(".products > div").length < 4 && (c = "left"), this.$el.find(".products > div").length < 5 && this.$el.addClass("desktop-controls-hidden")), this.instance.flickity({
                    ...
                    dragThreshold: bt.usingMobileBrowser ? 25 : 3,
                    accessibility: !1
                }), this.$el.is('[data-controls="touch_indicator"]')) bt.usingMobileBrowser || (Y.push(new $t(this.$el, "horizontal-movement")), this.instance.on("dragMove.flickity", function(t, e) {
                bt.clientY = e.clientY, bt.clientX = e.clientX
            ...
            get: function(t) {
                var n;
                return t.currentStyle ? n = t.currentStyle.color : e.getComputedStyle && (n = a.defaultView.getComputedStyle(t, null).getPropertyValue("color")), -1 == n.search("rgb") ? n : (n = n.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/)) ? "#" + Kt(n[1]) + Kt(n[2]) + Kt(n[3]) : void 0
            }
        }, t.cssHooks.backgroundColor = {
            get: function(t) {
                var n;
                return t.currentStyle ? n = t.currentStyle.backgroundColor : e.getComputedStyle && (n = a.defaultView.getComputedStyle(t, null).getPropertyValue("background-color")), -1 == n.search("rgb") ? n : (n = n.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/)) ? "#" + Kt(n[1]) + Kt(n[2]) + Kt(n[3]) : void 0
            }
        },
        function(t) {
            function n(a, i) {
            ...
            n.VERSION = "3.2.0", n.DEFAULTS = {
                ...
                var e, a = bt.scrollTop + this.options.offset + this.pageSubmenuHeight,
    ...
    function ce() {
        ...
        t(".wpb_gallery .wpb_gallery_slidesnectarslider_style").each(function() {
            e = te(), t(this).find(".swiper-slide a:not(.ext-url-link)").attr("data-fancybox", "group_" + e)
        }), t('.wpb_gallery_slides.wpb_flexslider:not([data-onclick="custom_link"])').each(function() {
            e = te(), t(this).find(".slides > li > a").attr("data-fancybox", "group_" + e)
        }), t(".wpb_gallery_slidesflickity_style, .wpb_gallery_slidesflickity_static_height_style").each(function() {
            e = te(), t(this).find(".cell > a:not(.ext-url-link)").attr("data-fancybox", "group_" + e)
        }), t(".portfolio-items, .wpb_gallery_slidesparallax_image_grid, .nectar-post-grid-item").each(function() {
            e = te(), t(this).find(".pretty_photo").length > 0 ? t(this).find(".pretty_photo").removeClass("pretty_photo").attr("data-fancybox", "group_" + e) : t(this).find('a[rel*="prettyPhoto["]').length > 0 && t(this).find('a[rel*="prettyPhoto["]').removeAttr("rel").attr("data-fancybox", "group_" + e)
        ...
        bt.winW < 1e3 && (a = [0, 0]), t("[data-fancybox]").fancybox({
    ...
    function he() {
        setTimeout(function() {
            ...
            })) : t('body[data-ls="fancybox"]').length > 0 && (t().fancybox ? ce() : setTimeout(ce, 200))
        }, 60)
    }
    ...
    function me() {
        r.on("click", ".tabbed > ul li:not(.cta-button) a", function(a) {
            if (function(a) {
                    ...
                    if (a.closest(".tabbed").length > 0 && a.closest(".tabbed").is('[data-style="toggle_button"]') && 3 === n && (n = 2), !a.hasClass("active-tab") && !a.hasClass("loading")) {
                        ...
                        if (t("body.vc_editor").length > 0) {
                            ...
                            a.parents('.tabbed[data-style="toggle_button"]').length > 0 && a.parents("li").index() + 1 === 3 && a.parents(".wpb_tabs_nav").find(".toggle-button[data-m-id]").length > 0 && (l = a.parents(".wpb_tabs_nav").find(".toggle-button").attr("data-m-id")), a.parents(".tabbed").find('> div[data-model-id="' + l + '"]' + i).css({
                                ...
                                opacity: 1
                            }, o).addClass("visible-tab"), r.is('[data-flex-cols="true"]') || bi()
                    ...
                    c.find(".nectar-progress-bar").length > 0 && Ke(), (c.find('.divider-small-border [data-animate="yes"]').length > 0 || c.find('.divider-border [data-animate="yes"]').length > 0) && na(), (c.find("img.img-with-animation").length > 0 || c.find(".col.has-animation").length > 0 || c.find(".nectar_cascading_images").length > 0 || c.find(".wpb_column.has-animation").length > 0) && (Qe(), Ze()), (c.find(".parallax-layer").length > 0 || c.parents(".nectar-parallax-enabled").length > 0) && Ye(), Fe(), c.find(".nectar-milestone").length > 0 && fe(), c.find('.nectar_image_with_hotspots[data-animation="true"]').length > 0 && (ra(), setTimeout(function() {
                        s.trigger("resize")
                    }, 100)), c.find(".nectar-fancy-ul").length > 0 && Oe(), c.find(".nectar-split-heading").length > 0 && Ue(), c.find('.wpb_column[data-border-animation="true"]').length > 0 && ta(), c.find(".wpb_animate_when_almost_visible").length > 0 && ue(), c.find(".nectar-animated-title").length > 0 && ma(), c.find(".nectar-highlighted-text").length > 0 && va(), c.find(".nectar_food_menu_item").length > 0 && aa(), c.find('.nectar-post-grid:not([data-animation="none"])').length > 0 && ga(), c.find(".nectar-waypoint-el").length > 0 && ea(), a.parents(".wpb_row").length > 0 && ((c.find(".vc_pie_chart").length > 0 || c.find(".wp-video-shortcode").length > 0 || c.find(".post-area.masonry .posts-container").length > 0 || c.find(".twentytwenty-container").length > 0 || a.parents('#nectar_fullscreen_rows[data-content-overflow="scrollbar"]').length > 0 || a.parents(".tabbed").find("> div:nth-of-type(" + n + ")").find(".wpb_gallery").length > 0 || a.parents(".tabbed").find("> div:nth-of-type(" + n + ")").find(".swiper-container").length > 0 || a.parents(".wpb_row").next().hasClass("parallax_section")) && s.trigger("resize"), c.find(".nectar-flickity").length > 0 && "undefined" != typeof Flickity && a.parents(".tabbed").find("> div:nth-of-type(" + n + ")").find(".nectar-flickity").each(function() {
                        ...
                        setTimeout(function() {
                            var t = 0;
                            a.is("[data-animation-delay]") && a.attr("data-animation-delay").length > 0 && "false" != a.attr("data-animation") && (t = a.attr("data-animation-delay")), clearTimeout(st[e]), "false" == a.attr("data-animation") ? (a.css("opacity", "1"), q[a.find("svg").attr("id").slice(-1)].finish()) : (q[a.find("svg").attr("id").slice(-1)].reset(), st[e] = setTimeout(function() {
                    ...
                    }), 0, a.parent().parent().find(".magic-line").length > 0 && ge(a), t(e).trigger("nectar-tab-changed")
                }(t(this)), void 0 !== a.originalEvent && bt.winW < 1e3 && 0 == mt.$usingFullScreenRows && !t(this).parents(".disable-mobile-tab-scroll")) {
                var n = t(this).closest(".tabbed").find("> ul");
                if (n.height() > 350) {
                    var i = n.offset().top + n.height() - bt.adminBarHeight;
                    t('#header-outer[data-mobile-fixed="1"]').length > 0 && (i = n.offset().top + n.height() - d.outerHeight() - bt.adminBarHeight), ee(i, 0, "easeInOutQuint")
                }
            }
            return !1
            ...
            t(this).find(".wpb_tab").each(function(e) {
                ...
                e.is('[data-style="minimal_alt"]') && (e.find("> ul").append('<li class="magic-line" />'), ge(e.find("> ul > li:first-child > a")))
            }, 100)
        }), t('.tabbed[data-style="minimal_alt"]').length > 0 && s.on("smartresize", function() {
            t('.tabbed[data-style="minimal_alt"]').each(function() {
                t(this).find("a.active-tab").length > 0 && ge(t(this).find("a.active-tab"))
            })
        }), void 0 !== re.tab && t(".wpb_tabs_nav").each(function() {
            t(this).find("li").each(function() {
                var e = t(this).find("a").clone(),
                    a = re.tab,
                    n = t(this);
        ...
        r.on("click", ".scrolling-tab-nav-current-item", function() {
            t(this).toggleClass("open"), t(this).siblings(".wpb_tabs_nav").toggle(), Fe()
        ...
        }), a = !1, t(".nectar-sticky-tabs").addClass("loaded"), t(e).on("nectar-tab-changed", ba)
    }
    ...
    function be() {
        void 0 !== re.toggle && t(".toggles").each(function() {
    ...
    function ye() {
        ...
        }, 60), t('.toggle[data-inner-wrap="true"]').length > 0 && s.on("smartresize", we), t(".toggle > h3:not(.toggle-title)").addClass("toggle-title")
    }
        ...
        t(".nectar-3d-transparent-button").each(function() {
            if ("visible" == t(this).css("visibility")) {
                ...
                if ("extra_jumbo" == e.attr("data-size")) {
                    var i;
                    bt.winW < 1e3 && bt.winW > 690 ? (a = 64, i = 34, e.find(".back-3d rect").attr("stroke-width", "12"), n = 1.7) : bt.winW <= 690 ? (a = 46, i = 16, e.find(".back-3d rect").attr("stroke-width", "10"), n = 1.7) : (a = 100, i = 64, e.find(".back-3d rect").attr("stroke-width", "20"), n = 1.6), e.find("svg text").attr("font-size", i);
    ...
    function ke() {
        if (bt.usingMobileBrowser || t('.nectar-cta[data-style="text-reveal-wave"], .menu-item-hover-text-reveal-wave, .nectar-cta[data-style="curved-arrow-animation"]').each(function() {
        ...
        if (t(".nectar-3d-transparent-button").length > 0) {
            ...
            }), xe(), s.on("smartresize", xe), de(n, "nectar-td-button")
        }
        setTimeout(function() {
    ...
    function Se() {
        ...
        }), !bt.usingMobileBrowser && t('body[data-boxed-style="1"]').length > 0 && t("#boxed").length > 0 && t("#boxed").length > 0 && t(".full-width-section[data-top-percent], .full-width-section[data-bottom-percent], .full-width-content[data-top-percent], .full-width-content[data-bottom-percent]").each(function() {
    ...
    function Ae() {
        if (0 != t('.carousel-wrap[data-full-width="true"], .portfolio-items[data-col-num="elastic"]:not(.fullwidth-constrained), #boxed .full-width-content').length) {
            var n, i, r, o = bt.winW,
                l = t(".body-border-right").length > 0 && o > 1e3 || t(".body-border-right").length > 0 && e.nectarOptions && e.nectarOptions.body_border_mobile && "1" === e.nectarOptions.body_border_mobile ? 2 * parseInt(t(".body-border-right").width()) : 0,
            ...
            t(".carousel-outer").has('.carousel-wrap[data-full-width="true"]').css("overflow", "visible"), t('.carousel-wrap[data-full-width="true"], .portfolio-items[data-col-num="elastic"]:not(.fullwidth-constrained), #boxed .full-width-content').each(function() {
                var a = t('#header-outer[data-format="left-header"]').length > 0 && o >= 1e3 ? parseInt(t('#header-outer[data-format="left-header"]').width()) : 0,
                    s = t(".body-border-right").length > 0 && o > 1e3 || t(".body-border-right").length > 0 && e.nectarOptions && e.nectarOptions.body_border_mobile && "1" === e.nectarOptions.body_border_mobile ? 2 * parseInt(t(".body-border-right").width()) - 2 : 0;
                if (1 == t("#boxed").length) {
                    var l = o >= 690 ? parseInt(t(".main-content").width()) : h;
                    r = 0 == t("#nectar_fullscreen_rows").length ? l : parseInt(t(this).parents(".container").width()), t('body.single-post[data-ext-responsive="true"]').length > 0 && t(".container-wrap.no-sidebar").length > 0 && t(this).parents(".post-area").length > 0 ? (f = t(".post-area").width(), p = 0, n = d - s, i = Math.ceil((n + p - f) / 2)) : i = t(this).parents(".page-submenu").length > 0 ? (parseInt(t(".container-wrap").width()) - r) / 2 : (parseInt(t(".container-wrap").width()) - r) / 2 + 4
                } else {
                    if (t('body.single-post[data-ext-responsive="true"]').length > 0 && t(".container-wrap.no-sidebar").length > 0 && t(this).parents(".post-area").length > 0) f = t(".post-area").width(), p = 0, n = d - s;
                    else {
                        var u = 0 == t("#nectar_fullscreen_rows").length ? h : parseInt(t(this).parents(".container").css("max-width"));
                        d - s <= u && (n = u), f = u, p = t('body[data-ext-responsive="true"]').length > 0 && bt.winW >= 1e3 ? c : 0, a > 0 && (p = t('body[data-ext-responsive="true"]').length > 0 && bt.winW >= 1e3 ? 120 : 0)
                    }
                    i = Math.ceil((n + p - f) / 2)
                }
                var g = 0;
                t(this).hasClass("carousel-wrap") && (g = 1), t(this).hasClass("portfolio-items") && (g = 5);
                var m = 1 == t("#boxed").length ? r + parseInt(2 * i) : d - s + g;
                if (0 == t("#boxed").length && t(this).hasClass("portfolio-items") && t(this).is('[data-gutter*="px"]') && t(this).attr("data-gutter").length > 0 && "none" != t(this).attr("data-gutter") && (m = d > 1e3 ? d - s + 3 : d - s), t(this).parent().hasClass("default-style")) r = 0 == t("#nectar_fullscreen_rows").length ? parseInt(t(".main-content").width()) : parseInt(t(this).parents(".container").width()), 0 != t("#boxed").length ? m = 1 == t("#boxed").length ? r + parseInt(2 * i) : d + g : (m = 1 == t("#boxed").length ? r + parseInt(2 * i) : d - s - .025 * (d - s) + g, n = d - s <= r ? r : d - s - .025 * (d - s), i = Math.ceil((n - r) / 2));
                else if (t(this).parent().hasClass("spaced"))
                    if (r = 0 == t("#nectar_fullscreen_rows").length ? parseInt(t(".main-content").width()) : parseInt(t(this).parents(".container").width()), 0 != t("#boxed").length) m = 1 == t("#boxed").length ? r + parseInt(2 * i) - .02 * d : d + g;
                    else {
                        m = 1 == t("#boxed").length ? r + parseInt(2 * i) : d - s - Math.ceil(.02 * (d - s)) + g;
                        var v = d - s <= r ? r : d - s - .02 * (d - s);
                        i = Math.ceil((v - r) / 2 + 2)
    ...
    function We(t) {
        if (this.$element = t, this.$elementInner = t.find("> .vc_column-inner"), this.inView = !1, this.topLevel = !1, this.bottomLevel = !1, this.lastY = 0, this.lerp = t.data("scroll-animation-lerp") ? parseFloat(t.data("scroll-animation-lerp")) : .28, this.intensity = t.data("scroll-animation-intensity") ? Math.max(Math.min(parseFloat(t.data("scroll-animation-intensity")), 8), -8) : 3, this.intensity = this.intensity / 10, this.storedWinH = bt.winH, this.intensity < -.29 && (this.lerp = 1), this.type = "translateY", this.persistOnMobile = !(!t.is("[data-scroll-animation-mobile]") || "true" != t.attr("data-scroll-animation-mobile")), this.$element.hasClass("wpb_column") || 0 != this.$element.parents(".cell").length || (this.$elementInner = t, this.$element = t.parent(), t.is("[data-scroll-animation-movement]") && this.$element.attr("data-scroll-animation-movement", t.attr("data-scroll-animation-movement"))), !bt.usingMobileBrowser || 0 != this.persistOnMobile) {
    ...
    function Be(t, e, a, n) {
        this.$el = t, this.$parallaxEl = this.$el.find(e), this.firstSection = !1, this.nestedParallax = !1, this.type = n, this.speed = a, this.storedWinH = bt.winH, t.parents(".nectar-sticky-tabs").length > 0 || t.parents(".nectar-sticky-column-css").length > 0 || t.parents(".nectar-global-section-megamenu").length > 0 || (this.setup(), this.update())
    }
    ...
    function Le(t) {
        ...
        }, this.needsReset = !0, this.activeDevice = "desktop", this.storedWinH = bt.winH, this.setupProps(), this.lazyInit()
    }

    function qe() {
        G = [], t("[data-nectar-animate-settings]").each(function() {
    ...
    function je() {
        if (!(bt.usingMobileBrowser && t('body[data-remove-m-parallax="1"]').length > 0)) {
            Z = [], t('.wpb_column[data-scroll-animation="true"], .nectar-el-parallax-scroll[data-scroll-animation="true"]').each(function(e) {
                imagesLoaded(t(this), function(e) {
                    t(e.elements[0]).is('[data-scroll-animation="true"]') && 0 == t("#nectar_fullscreen_rows").length && 0 === t(e.elements[0]).parents(".n-sticky").length && 0 === t(e.elements[0]).parents(".nectar-global-section-megamenu").length && Z.push(new We(t(e.elements[0])))
                })
            }), Ye();
            var e = 0;
            t('.nectar-recent-posts-single_featured, [data-n-parallax-bg="true"], .wpb_row.parallax_section, #page-header-bg[data-parallax="1"] .page-header-bg-image-wrap, #page-header-bg[data-parallax="1"] .nectar-video-wrap, .parallax_slider_outer .nectar-slider-wrap').each(function() {
                t(this).is("[data-n-parallax-bg][data-parallax-speed]") ? (D[e] = new Be(t(this), ".parallax-layer", Pe(t(this).attr("data-parallax-speed")), "regular"), e++) : 0 == t(this).find('[data-parallax-speed="fixed"]').length && (t(this).hasClass("nectar-slider-wrap") ? D[e] = new Be(t(this), ".video-wrap, .image-bg", .25, "nectar-slider") : t(this).hasClass("page-header-bg-image-wrap") ? D[e] = new Be(t(this), ".page-header-bg-image", .25, "page-header") : t(this).hasClass("nectar-video-wrap") && t(this).parents("#page-header-bg").length > 0 ? D[e] = new Be(t(this), ".nectar-video-bg", .25, "page-header") : (t(this).find(".row-bg.using-image").length > 0 && (D[e] = new Be(t(this), ".row-bg.using-image", Pe(t(this).find(".row-bg").attr("data-parallax-speed")), "regular")), t(this).find("> .nectar-video-wrap").length > 0 && (D[e] = new Be(t(this), "> .nectar-video-wrap .nectar-video-bg", Pe(t(this).find(".row-bg").attr("data-parallax-speed")), "regular"))), e++), t(this).addClass("nectar-parallax-enabled")
    ...
    function Ye() {
        bt.usingMobileBrowser && t('body[data-remove-m-parallax="1"]').length > 0 || t('.nectar-recent-posts-single_featured, [data-n-parallax-bg="true"], .wpb_row.parallax_section, #page-header-bg[data-parallax="1"] .page-header-bg-image-wrap, .parallax_slider_outer .nectar-slider-wrap .slide-bg-wrap').each(function() {
            var e;
            ...
            if (0 == t(this).find(".row-bg").length && t(this).find(".page-header-bg-image").length > 0 || 0 == t(this).find(".row-bg").length && t(this).find(".image-bg").length > 0 && (e = !1, 0 == t(".wpb_row").length && t(this).parents('.nectar-slider-wrap[data-full-width="true"]').length > 0 && t(this).parents(".parallax_slider_outer").length > 0 && "1" == t(this).parents(".parallax_slider_outer").index() && (e = !0), t("#portfolio-extra").length > 0 && t(this).parents(".wpb_row").length > 0 && t(this).parents(".parallax_slider_outer").length > 0 && "0" == t(this).parents(".wpb_row").index() && (e = !0), t(this).parents(".top-level").length > 0 && !bt.usingFrontEndEditor || e && !bt.usingFrontEndEditor ? t(this).find(".image-bg").css({
                ...
                })), 0 == t(this).find(".row-bg").length && t(this).find(".video-wrap").length > 0) {
                e = !1, 0 == t(".wpb_row").length && t(this).parents('.nectar-slider-wrap[data-full-width="true"]').length > 0 && t(this).parents(".parallax_slider_outer").length > 0 && "1" == t(this).parents(".parallax_slider_outer").index() && (e = !0), t("#portfolio-extra").length > 0 && t(this).parents(".wpb_row").length > 0 && t(this).parents(".parallax_slider_outer").length > 0 && "0" == t(this).parents(".wpb_row").index() && (e = !0), t(this).parents(".top-level").length > 0 && !bt.usingFrontEndEditor || e && !bt.usingFrontEndEditor ? t(this).find(".video-wrap").css({
                    height: Math.ceil(.25 * t(this).parent().offset().top) + t(this).outerHeight(!0)
                }) : t(this).find(".video-wrap").css({
                    height: Math.ceil(.25 * bt.winH) + t(this).outerHeight(!0)
                });
            ...
            } else if (t(this).is(".nectar-recent-posts-single_featured") && t(this).parents(".top-level").length > 0 && !bt.usingFrontEndEditor);
            else if (t(this).is(".nectar-simple-slider") && t(this).parents(".top-level").length > 0 && !bt.usingFrontEndEditor);
            ...
            else if (!t(this).hasClass("top-level") || bt.usingFrontEndEditor || t(this).find(".parallax-layer").length > 0) {
                ...
                0 == t(this).parents("#page-header-bg").length && t(this).find(o).css({
                    height: Math.ceil(bt.winH * Pe(l)) + t(this).outerHeight(!0) + d
                })
            }
        })
    }
    ...
    function Ve() {
        ...
        t(".main-content > .row > " + e + " .full-width-content, #portfolio-extra > " + e + " .full-width-content, .woocommerce-tabs #tab-description > .full-width-content, .post-area.span_12 article .content-inner > .full-width-content").each(function() {
            if (t(this).find("> .span_12 > " + e + " .col").length > 1) {
                ...
                }), bt.winW < 1e3 && t(this).find("> .span_12 > " + e + " .col .wpb_row .col").css("min-height", "0px"), t(this).hasClass("vertically-align-columns") && bt.winW > 1e3 && !t(this).hasClass("vc_row-o-equal-height") && t(this).find("> .span_12 > " + e + " .col").each(function() {
    ...
    function Xe() {
        t(".wpb_row:has(.nectar-parallax-scene)").each(function(e) {
            ...
            et[e] = t(this).find(".nectar-parallax-scene").parallax({
                scalarX: a,
                scalarY: a
            });
    ...
    function Qe() {
                    ...
                    if (n.parents(".wpb_tab").length > 0 && "hidden" == n.parents(".wpb_tab").css("visibility") || n.hasClass("animated-in")) o.destroy();
                        ...
                        if (!S || t('body[data-responsive="0"]').length > 0) {
                            var e = n.is("[data-delay]") ? n.attr("data-delay") : 0,
                                ...
                                l = z;
                            n.parents(".nectar-disable-mobile-animation").length > 0 && bt.winW < 1e3 && (l = 0, r = 0, e = 0), "fade-in-from-left" == i || "fade-in-from-right" == i ? a.delay(e).transition({
                                opacity: 1,
                                x: "0px"
                            }, l, s) : "fade-in-from-bottom" == i ? it.push(anime({
                                targets: a[0],
                                translateY: [100, 0],
                                translateZ: 0,
                                opacity: {
        ...
        }), t(ht + '.col.has-animation:not([data-animation*="reveal"]), ' + ht + '.wpb_column.has-animation:not([data-animation*="reveal"]), ' + ht + ".nectar-fancy-box.has-animation").each(function(n) {
            if (v && t(this).parents(".top-level").length > 0 && !0 !== mt.$usingFullScreenRows) return !0;
            var i = t(this),
                s = a;
                    ...
                    if (i.parents(".wpb_tab").length > 0 && "hidden" == i.parents(".wpb_tab").css("visibility") || i.hasClass("animated-in")) l.destroy();
                        ...
                        if (!S || t('body[data-responsive="0"]').length > 0) {
                            ...
                            var a = i.attr("data-delay"),
                                s = z;
                            if (i.hasClass("mobile-disable-entrance-animation") && bt.winW < 1e3 && (s = 0, o = 0, a = 0), "fade-in-from-left" == i.attr("data-animation") || "fade-in-from-right" == i.attr("data-animation")) nt[n] = setTimeout(function() {
                                i.transition({
                                    opacity: 1,
                                    x: "0px"
                                }, s, r)
                            ...
                            } else "fade-in" == i.attr("data-animation") ? nt[n] = setTimeout(function() {
                                i.transition({
                                    opacity: 1
                                }, s, r)
                            }, a) : "grow-in" == i.attr("data-animation") || "zoom-out" == i.attr("data-animation") ? nt[n] = setTimeout(function() {
                                i.transition({
                                    scale: 1,
                                    opacity: 1
                                }, s, r)
                            }, a) : "flip-in" == i.attr("data-animation") ? nt[n] = setTimeout(function() {
                                i.transition({
                                    rotateY: "0",
                                    opacity: 1
                                }, s, r)
                            }, a) : "flip-in-vertical" == i.attr("data-animation") ? nt[n] = setTimeout(function() {
                                i.transition({
                                    rotateX: "0",
                                    y: "0",
                                    opacity: 1
                                }, s, r)
                            }, a) : "slight-twist" == i.attr("data-animation") && (nt[n] = setTimeout(function() {
                                it.push(anime({
                                    targets: i[0],
                                    rotateY: [20, 0],
                                    rotateZ: [-4, 0],
        ...
        }), t(ht + '.wpb_column.has-animation[data-animation*="reveal"]').each(function() {
            var e = O;
    ...
    function Ue() {
        t(ht + ".nectar-split-heading:not(.custom-trigger)").each(function(e) {
            ...
            t(this)[0].hasAttribute("data-animation-offset") && 1 != ut && t(this).attr("data-animation-offset").length > 0 && (a = parseInt(t(this).attr("data-animation-offset")) + "%");
            var n = t(this),
                        ...
                        if (n.parents(".wpb_tab").length > 0 && "hidden" == n.parents(".wpb_tab").css("visibility") || n.hasClass("animated-in")) s.destroy();
                            ...
                            if (!S || t('body[data-responsive="0"]').length > 0) setTimeout(function() {
                                if (n.is('[data-animation-type="line-reveal-by-space"]:not([data-text-effect*="letter-reveal"])')) {
                                    var a = 0;
                                    n.is('[data-stagger="true"]') && (a = 500 / n.find("> * > span").length, a = Math.min(Math.max(a, 15), 50)), e = parseInt(z) < 1100 ? z : "1100", n.is('[data-m-rm-animation="true"]') && bt.winW < 1e3 ? n.find("> * > span .inner").css({
                                    ...
                                    a = 400 / i.length, a = Math.min(Math.max(a, 20), 35), i.length > 0 && it.push(anime({
            ...
            if (!0 === mt.$usingFullScreenRows) var a = t(this),
                n = new Waypoint({
                    element: a[0],
                    handler: function() {
    ...
    function Je(t) {
        this.$el = t, this.inView = !1, this.timeline = null, this.duration = 450, this.speed = 1.9, this.wordDelay = 150, this.topLevel = !1, this.topCushion = .05 * bt.winH, this.mergedGroup = !1, this.$el.parents(".wpb_row.nectar-split-heading-merged").length > 0 || (this.mergeNeighbors(), this.trackInView(), this.createTimeline(), this.events(), this.raf())
    }

    function Ke() {
        var e = 1 == ut ? "500%" : "bottom-in-view",
            a = t('#nectar_fullscreen_rows[data-mobile-disable="on"]').length > 0 && bt.usingMobileBrowser ? ".nectar-progress-bar" : ht + ".nectar-progress-bar";
        bt.usingMobileBrowser && "bottom-in-view" == e && (e = "70%"), t(a).each(function() {
            var a = t(this),
                n = new Waypoint({
                    element: a[0],
                    handler: function() {
    ...
    function aa() {
        var e = 1 == ut ? "500%" : "80%";
        t(ht + ".nectar_food_menu_item").parent().each(function() {
            var a = t(this),
                n = new Waypoint({
                    element: a[0],
                    handler: function() {
    ...
    function na() {
        var e = 1 == ut ? "500%" : "bottom-in-view";
        t(ht + '.divider-small-border[data-animate="yes"], ' + ht + '.divider-border[data-animate="yes"]').each(function() {
    ...
    function sa() {
        0 != t(".nectar_image_with_hotspots").length && (! function() {
            ...
            if (t(this).parents(".nectar_image_with_hotspots").find(".nttip").removeClass("open"), t(this).parent().find(".nttip").addClass("open"), t(this).parents(".nectar_image_with_hotspots").find(".nectar_hotspot").removeClass("open"), t(this).parent().find(".nectar_hotspot").addClass("open"), bt.winW > 690) {
                t(this).parent().css({
                    "z-index": "120",
                    height: "auto",
                    width: "auto"
            ...
            return bt.winW <= 690 && (t("body.nectar_box_roll").length > 0 && t(".container-wrap").addClass("hotspot-open"), t(".nectar_hotspot.click").parents('.wpb_row, [class*="vc_col-"]').css("z-index", ""), t(this).parents('.wpb_row, [class*="vc_col-"]').css("z-index", "200")), !1
    ...
    function ra() {
        var e = 1 == ut ? "500%" : "50%";
        t(ht + '.nectar_image_with_hotspots[data-animation="true"]').each(function() {
            var a = t(this),
                n = new Waypoint({
                    element: a[0],
                    handler: function() {
    ...
    function ca() {
        ...
        if ("IntersectionObserver" in e) {
            s.off("resize.nectarLazySizing", ha), s.on("resize.nectarLazySizing", ha), ft = new IntersectionObserver(function(t) {
    ...
    function ua() {
        R = [], N = [], bt.usingMobileBrowser || (t('.nectar-post-grid[data-indicator="yes"]').each(function(e) {
    ...
    function pa() {
        ot = [], ua(), t(".nectar-post-grid-wrap").each(function(e) {
            ot[e] = new fa(t(this))
        })
    }
    ...
    function ga() {
        ...
        t(ht + ".nectar-post-grid-wrap").each(function() {
            if (!v || !t(this).hasClass("delay-js-loaded") || 0 != mt.$usingFullScreenRows) var a = t(this),
                n = new Waypoint({
                    element: a[0],
                    handler: function() {
                        if (a.parents(".wpb_tab").length > 0 && "hidden" == a.parents(".wpb_tab").css("visibility") || a.hasClass("completed")) n.destroy();
                            ...
                            a.find(".nectar-post-grid__reveal-image__inner").length > 0 && a.find(".nectar-post-grid__reveal-image__inner").css({
                                ...
                                var n = t(this);
                                setTimeout(function() {
                                    n.addClass("animated-in"), "zoom-out-reveal" === i && Fn(n, function() {
                                        Ln(n)
                                    })
                                }, a * e)
                            }), setTimeout(function() {
    ...
    function va() {
        var e = 1 == ut ? "500%" : "bottom-in-view";
        bt.usingMobileBrowser && "bottom-in-view" == e && (e = "85%"), t(ht + ".nectar-highlighted-text").each(function(a) {
            var n = 0;
    ...
    function ya() {
        tt = [], "undefined" != typeof NectarTestimonialSlider ? t(".testimonial_slider").each(function(e) {
            var a = t(this),
                n = t(this).is("[data-style]") ? t(this).attr("data-style") : "none";
            tt[e] = new NectarTestimonialSlider(a, n, za, Ve), t(this).is('.disable-height-animation:not([data-style*="multiple_visible"])') && (tt[e].testimonialSliderHeight(), setTimeout(tt[e].testimonialSliderHeight.bind(tt[e]), 700)), t(this).is('.testimonial_slider[data-style="multiple_visible_minimal"]') && tt[e].testimonialSliderHeightMinimalMult()
        }) : Ut("#nectar-testimonial-sliders-js", 0, ya)
    }

    function _a() {
        s.off("smartresize.nectarTestimonials"), s.off("resize.nectarTestimonialsMin"), tt.length > 0 && s.on("smartresize.nectarTestimonials", Ca), t('.testimonial_slider[data-style="multiple_visible_minimal"]').length > 0 && s.on("resize.nectarTestimonialsMin", xa)
    }

    function Ca() {
        for (var t = 0; t < tt.length; t++) tt[t].testimonialSliderHeight(), tt[t].testimonialHeightResize()
    }

    function xa() {
        for (var t = 0; t < tt.length; t++) tt[t].testimonialSliderHeightMinimalMult()
    }
    ...
    function Ha() {
        ...
        0 == t(".nectar-video-wrap").length && 0 == t(".nectar-youtube-bg").length || (setTimeout(function() {
            t(".video-color-overlay").each(function() {
                ...
                if (0 != t(this).find("video").length) {
                    ...
                    if (0 === t(this).find("video.nectar-lazy-video").length) var n = setInterval(function() {
                        a.find("video").get(0).readyState > 3 && (bt.usingMobileBrowser || (a.transition({
                            opacity: "1"
                        }, 400), a.find("video").transition({
                            opacity: "1"
                        }, 400), a.parent().find(".video-color-overlay").transition({
                            opacity: "0.7"
                        }, 400), 1 == e && en()), p.addClass("loaded"), setTimeout(function() {
                            p.addClass("hidden")
                        }, 1e3), clearInterval(n))
                    }, 60);
                    bt.usingMobileBrowser && (a.parents(".full-width-section").length > 0 && 0 == a.parents("#nectar_fullscreen_rows").length && !a.hasClass("column-video") ? a.css("left", "50%") : a.css("left", "0px"), 1 == e && en(), a.find("video")[0].onplay = function() {
                        a.transition({
                            opacity: "1"
                        }, 400), a.find("video").transition({
                            opacity: "1"
        ...
        }, 300), bt.usingMobileBrowser && t(".nectar-video-wrap").each(function() {
            ...
            }(n.find(".nectar-youtube-bg"), t)) : n.find(".nectar-youtube-bg").remove(), n.find(".nectar-youtube-bg span").remove(), bt.usingMobileBrowser || n.find(".nectar-video-wrap, .nectar-youtube-bg").css({
                opacity: "1",
                width: "100%",
                height: "100%"
    ...
    function Sa() {
        if (r.hasClass("single-post") && t(".content-inner[data-has-gallery]").length > 0 && (t(".wp-block-gallery").length > 0 ? t(".content-inner").find(".wp-block-gallery").each(function(e) {
            ...
            new Waypoint({
                ...
                handler: function(t) {
                    yt.materialOffCanvasOpen || ("down" === t ? e.addClass("visible") : e.removeClass("visible"))
                },
                offset: "70%"
            })
        }
    ...
    function Aa() {
        if (t('body.material[data-slide-out-widget-area-style="slide-out-from-right"]').length > 0 && (Wa(), u.length > 0)) {
            var a = u.detach();
            t(".ocm-effect-wrap-inner").append(a)
        }! function() {
            if (t("body.material").length > 0 && 0 == t('body[data-slide-out-widget-area-style="slide-out-from-right-hover"]').length || t("body.material").length > 0 && !0 === W) {
        ...
        function() {
            if (t('body.material[data-header-search="true"]').length > 0 || t("body.material .ocm-effect-wrap").length > 0) {
                ...
                e.addEventListener("orientationchange", function() {
                    ...
                    bt.usingMobileBrowser ? (s.width() != r && s.height != o || 1 === i) && (r = bt.winW, o = bt.winH, i = 0, n = !0) : n = !0, n && (clearTimeout(a), t('body[data-slide-out-widget-area-style="slide-out-from-right"] > a.slide_out_area_close, .material #header-outer, .ocm-effect-wrap, .ocm-effect-wrap-shadow').addClass("no-material-transition"), a = setTimeout(function() {
    ...
    function Ma() {
        ...
        t("#slide-out-widget-area > .widget").each(function() {
            a += t(this).height()
        }), e = o.height() - 25 - t(".bottom-meta-wrap").outerHeight(!0) - a > t("#slide-out-widget-area .off-canvas-menu-container:last-child").height() ? o.height() - 25 - t(".bottom-meta-wrap").outerHeight(!0) - a : t("#slide-out-widget-area .off-canvas-menu-container:last-child").height(), t("#slide-out-widget-area .inner").first().css({
            height: "auto",
            "min-height": e
        })
    }
    ...
    function La() {
        e.nectarOptions && e.nectarOptions.ocm_remove_ext_menu_items && "remove_images" == e.nectarOptions.ocm_remove_ext_menu_items && !1 === yt.ocmInit && (t('.off-canvas-menu-container .title[class*="inherit-h"], #mobile-menu .title[class*="inherit-h"]').removeClass(function(t, e) {
    ...
    function qa() {
        bt.winW < 1e3 || t("body > #boxed").length > 0 || t(".ocm-effect-wrap-inner > #boxed").length > 0 ? (t("#slide-out-widget-area.fullscreen .off-canvas-social-links, #slide-out-widget-area.fullscreen-alt .off-canvas-social-links").appendTo("#slide-out-widget-area .inner-wrap > .inner"), t("#slide-out-widget-area.fullscreen .bottom-text, #slide-out-widget-area.fullscreen-alt .bottom-text").appendTo("#slide-out-widget-area .inner-wrap > .inner")) : (t("#slide-out-widget-area.fullscreen .off-canvas-social-links,#slide-out-widget-area.fullscreen-alt .off-canvas-social-links").appendTo("#slide-out-widget-area .inner-wrap"), t("#slide-out-widget-area.fullscreen .bottom-text, #slide-out-widget-area.fullscreen-alt .bottom-text").appendTo("#slide-out-widget-area .inner-wrap")), t(".slide-out-from-right.open .off-canvas-menu-container.mobile-only").length > 0 && 0 == t("body.mobile").length && t("#slide-out-widget-area .slide_out_area_close").trigger("click"), Fa()
    }

    function Pa() {
        if (Ma(), bt.usingMobileBrowser && t("#slide-out-widget-area.open").length > 0 || t(".slide-out-from-right-hover.ios-ocm-style").length > 0 && t("#slide-out-widget-area.open").length > 0) return Ya(), !1;
        (bt.usingMobileBrowser || t(".slide-out-from-right-hover.ios-ocm-style").length > 0) && (t(".slide-out-widget-area-toggle a").attr("aria-expanded", "true"), l.css({
            height: "100%",
            width: "100%"
        })), o.css({
            transform: "translate3d(0,0,0)"
        }).addClass("open"), La(), t(".slide-out-from-right-hover.ios-ocm-style").length > 0 && (t("#ajax-content-wrap").addClass("ios-ocm-style-open"), setTimeout(function() {
        ...
        if (t("header#top .container .span_9 > .slide-out-widget-area-toggle").length > 0) {
            var i, c = t(".slide-out-hover-icon-effect"),
                ...
                u = ae();
            if (t('#header-outer[data-format="centered-menu-bottom-bar"]').length > 0 && (u = !1), t("body.mobile").length > 0 || u || "left" === A) t(".left-aligned-ocm").length > 0 && "none" != t(".left-aligned-ocm").css("display") ? c.css({
                top: t("header#top .left-aligned-ocm .slide-out-widget-area-toggle a").offset().top - bt.scrollTop
            }) : c.css({
                top: t("header#top .span_9 > .slide-out-widget-area-toggle a").offset().top - bt.scrollTop
            }), "left" === n || "left" === A ? c.css({
                ...
                c.css({
                    top: bt.adminBarHeight + h + parseInt(t("header#top nav >ul .slide-out-widget-area-toggle a").css("padding-top")),
                    right: 29 + p
                })
        ...
        if (t(".slide-out-hover-icon-effect .lines-button").removeClass("no-delay").addClass("unhidden-line"), 0 == t('#header-outer[data-permanent-transparent="1"]').length && 0 == t("#nectar_fullscreen_rows").length && !bt.usingFrontEndEditor && bt.winW > 1e3 && (0 == bt.scrollTop && t("#header-outer.transparent").length > 0 || 0 == t("body.mobile").length && pt && (d.attr("data-transparent", "true").addClass("no-bg-color").addClass("slide-out-hover"), t("#header-outer header, #header-outer > .cart-outer").addClass("all-hidden")), 0 == t('#header-outer[data-remove-fixed="1"]').length && 0 == t("body.mobile").length && pt && (1 == k ? (s.off("scroll", _n), s.off("scroll", yn)) : (s.off("scroll", Cn), s.off("scroll", xn)))), bt.usingMobileBrowser) return !1;
    ...
    function ja(a) {
        var n = s.width(),
            ...
            r = ae();
        bt.winW < 1e3 && (r = !0);
        ("left" !== (e.nectarOptions && e.nectarOptions.mobile_header_format && "centered-menu" === e.nectarOptions.mobile_header_format && r ? "left" : "right") && "left" !== A ? a.clientX < n - parseInt(i) - b : a.clientX > parseInt(i) + b) && o.hasClass("mouse-accessed") && (o.removeClass("mouse-accessed"), s.off("mousemove.rightOffsetCheck", ja), o.css({
            transform: ""
        }).removeClass("open"), d.removeClass("style-slide-out-from-right"), t(".slide-out-hover-icon-effect .lines-button").removeClass("unhidden-line").addClass("no-delay"), 0 == t('#header-outer[data-permanent-transparent="1"]').length && (0 == t('#header-outer[data-remove-fixed="1"]').length && 0 == t("body.mobile").length && pt && 0 == t("body.mobile").length && (d.removeClass("no-bg-color"), t("#header-outer header, #header-outer > .cart-outer").removeClass("all-hidden")), 0 == t('#header-outer[data-remove-fixed="1"]').length && 0 == t("body.mobile").length && pt && (1 == k ? (s.off("scroll.headerResizeEffect"), 0 == bt.scrollTop ? (s.on("scroll.headerResizeEffect", yn), t('#header-outer[data-full-width="true"][data-transparent-header="true"]').length > 0 && f.length > 0 && 1 == pt && t("#header-outer.pseudo-data-transparent").length > 0 && t('#header-outer[data-full-width="true"] header > .container').stop(!0, !0).animate({
            padding: "0"
        }, {
            queue: !1,
            duration: 250,
            easing: "easeOutCubic"
        })) : s.on("scroll.headerResizeEffect", _n)) : (s.off("scroll.headerResizeEffectOpaque"), s.on("scroll.headerResizeEffectOpaque", Cn)))))
    }

    function Ya() {
        (bt.usingMobileBrowser || t(".slide-out-from-right-hover.ios-ocm-style").length > 0) && (t(".slide-out-widget-area-toggle a").attr("aria-expanded", "false"), l.css({
            height: "1px",
            width: "1px"
        })), t(".slide-out-from-right-hover.ios-ocm-style").length > 0 && (t("#ajax-content-wrap").removeClass("ios-ocm-style-open"), t("#slide-out-widget-area .slide_out_area_close").removeClass("material-ocm-open")), o.css({
            transform: ""
        }).removeClass("open"), d.removeClass("style-slide-out-from-right"), t(".slide-out-hover-icon-effect .lines-button").removeClass("unhidden-line").addClass("no-delay"), 0 == t('#header-outer[data-permanent-transparent="1"]').length && (d.removeClass("no-bg-color"), t("#header-outer header").removeClass("all-hidden")), 0 == t('#header-outer[data-remove-fixed="1"]').length && 0 == t("body.mobile").length && pt && (1 == k ? (s.off("scroll.headerResizeEffect"), 0 == bt.scrollTop ? (s.on("scroll.headerResizeEffect", yn), t('#header-outer[data-full-width="true"][data-transparent-header="true"]').length > 0 && f.length > 0 && 1 == pt && t("#header-outer.pseudo-data-transparent").length > 0 && t('#header-outer[data-full-width="true"] header > .container').stop(!0, !0).animate({
            padding: "0"
        }, {
            queue: !1,
            duration: 250,
    ...
    function Na() {
        function a() {
            if (yt.ocmAnimating || "true" == gt.animating || t(".slide-out-from-right-hover").length > 0) return !1;
            var a = 700;
            return yt.ocmOpen = !0, La(), d.removeClass("no-transition"), t(this).hasClass("simple-mobile-menu") ? (Va("simple-mobile-menu"), t(this).find("a").addClass("open"), !1) : (o.hasClass("slide-out-from-right") ? function() {
                ...
                if (0 == t("body.material").length) {
                    ...
                    0 == t('#header-outer[data-remove-fixed="1"]').length && bt.winW > 1e3 && (1 == pt && 1 == k && "true" == d.attr("data-transparent-header") ? (d.stop(!0).transition({
                        y: "0"
                    }, 0).addClass("transparent").css("transition", "transform"), s.off("scroll", _n), s.off("scroll", yn)) : 1 == pt && "true" == d.attr("data-transparent-header") && (d.addClass("transparent"), s.off("scroll", Cn), s.off("scroll", xn)))
                } else t("body.material").length > 0 && (p.length > 0 && t(".ocm-effect-wrap #ajax-loading-screen").length > 0 && p.insertBefore(".ocm-effect-wrap"), bt.scrollTop > 40 && t('body[data-hhun="1"] #header-secondary-outer').addClass("hidden"), setTimeout(function() {
                    t(".slide-out-widget-area-toggle:not(.std-menu) > div > a").removeClass("animating")
                }, 300), t("#slide-out-widget-area, #slide-out-widget-area-bg, #header-outer .slide-out-widget-area-toggle").addClass("material-open"), t('body:not(.mobile) #header-outer[data-format="centered-menu-bottom-bar"][data-condense="true"]').length > 0 && "none" != t('#header-outer[data-format="centered-menu-bottom-bar"] .span_9').css("display") && (t("#header-outer:not(.fixed-menu)").css("top", bt.adminBarHeight - bt.scrollTop + "px"), c.length > 0 && t("#header-outer.fixed-menu").length > 0 && c.css("visibility", "hidden")), t("#ajax-content-wrap").css({
                    position: "relative",
                    top: "-" + bt.scrollTop + "px"
                }), t(".ocm-effect-wrap-inner").css({
                    "padding-top": bt.adminBarHeight
                }), t("#fp-nav").addClass("material-ocm-open"), yt.materialOffCanvasOpen = !0, r.addClass("material-ocm-open"), r.addClass("nectar-no-flex-height"), t(".ocm-effect-wrap").css({
                    height: bt.winH
                }), setTimeout(function() {
                ...
                var e = 0,
                    a = 0;
                bt.scrollTop + s.height() > t(".blurred-wrap").height() && 0 == t("#nectar_fullscreen_rows").length && (t("body,html").stop().animate({
                ...
                }, e), t("#slide-out-widget-area.fullscreen").show().addClass("open"), 0 == t(".nectar-social.fixed").length && Kn(), t(".container-wrap").addClass("no-shadow"), d.stop(!0).css("transform", "translateY(0)"), setTimeout(function() {
                ...
                }, 50 + a), qa(), t('.mobile #header-outer[data-permanent-transparent="false"]').length > 0 && t(".container-wrap").hasClass("no-scroll") && t("#ajax-content-wrap").addClass("at-content");
                var n = d.offset().top - bt.scrollTop + bt.secondaryHeaderHeight;
                ...
                o.hasClass("fullscreen-split") && (e = ".fullscreen-split"), t("body.material").length > 0 && t("header#top .slide-out-widget-area-toggle a").addClass("menu-push-out"), t("header#top .slide-out-widget-area-toggle:not(.std-menu) .lines-button:not(.legacy-double)").addClass("close"), ".fullscreen-alt" === e ? t("#slide-out-widget-area" + e).show().addClass("open") : t("#slide-out-widget-area" + e).addClass("open").removeClass("hidden"), l.addClass("open").removeClass("hidden"), t('body > div[class*="body-border"]').css("z-index", "9995"), ".fullscreen-alt" === e && t(".off-canvas-menu-container .menu").transition({
                    y: "0px",
                    opacity: 1
                }, 0), 0 == t(".nectar-social.fixed").length && Kn(), t("#header-outer.transparent").length > 0 && f.length > 0 && (t(".admin-bar #slide-out-widget-area-bg" + e).css({
                    "padding-top": f.outerHeight(!0) + 32 + "px"
                }), t("body:not(.admin-bar) #slide-out-widget-area-bg" + e).css({
                    "padding-top": f.outerHeight(!0) + "px"
                })), d.stop(!0).css("transform", "translateY(0)"), s.width() > 1e3 && 0 == t('#header-outer[data-format="centered-menu-bottom-bar"].fixed-menu').length && 0 == t('body.material #header-outer[data-condense="true"]').length && "true" == d.attr("data-transparent-header") && !bt.usingFrontEndEditor && (t("#logo .starting-logo").length > 0 || t("#logo.no-image").length > 0) && d.stop(!0).css("transform", "translateY(0)").addClass("transparent"), t(".off-canvas-menu-container .clip-wrap").css("transition-duration", "0s"), ".fullscreen-alt" === e && (setTimeout(function() {
                    t(".off-canvas-menu-container .menu > li").each(function(e) {
                        t(this).delay(50 * e).transition({
                            y: 0,
                            opacity: 1
                ...
                if (t('body[data-contained-header="true"]').length > 0 && (n = 1.5 * d.outerHeight()), ".fullscreen-alt" === e) {
                    var i = d.offset().top - bt.scrollTop + bt.secondaryHeaderHeight;
                ...
                }), 0 == t(".nectar-social.fixed").length && Kn(), t("body.material").length > 0 && t("header#top .slide-out-widget-area-toggle a").addClass("menu-push-out"), t("header#top .slide-out-widget-area-toggle:not(.std-menu) .lines-button:not(.legacy-double)").addClass("close"), t("#slide-out-widget-area.fullscreen-inline-images").addClass("open").removeClass("hidden"), l.addClass("open").removeClass("hidden"), t('body > div[class*="body-border"]').css("z-index", "9995"), setTimeout(function() {
                    d.removeClass("side-widget-closed").addClass("side-widget-open"), $ || (d.attr("data-transparent-header", "true"), 0 === t("#logo .starting-logo:not(.dark-version)").length && d.addClass("lighten-logo")), bt.usingFrontEndEditor || d.stop(!0).css("transform", "translateY(0)").addClass("transparent"), t("#header-outer.dark-slide.transparent").length > 0 && 0 == t("#boxed").length && d.removeClass("dark-slide").addClass("temp-removed-dark-slide"), 0 === t('body[data-contained-header="true"]').length && setTimeout(function() {
                        anime({
            ...
            }(), a = 1100) : t("#header-outer #mobile-menu").length > 0 && (a = 150, Va("slide-out-widget-area-toggle")), yt.ocmAnimating = !0, setTimeout(function() {
                yt.ocmAnimating = !1
            }, a), 0 != t("#header-outer #mobile-menu").length || o.hasClass("fullscreen-inline-images") || (d.removeClass("side-widget-closed").addClass("side-widget-open"), t('#header-outer[data-transparency-option="1"]').length > 0 && 0 == t("#boxed").length && t('#header-outer[data-full-width="true"]').length > 0 && !bt.usingFrontEndEditor && 0 == t('body.material[data-slide-out-widget-area-style="slide-out-from-right"]').length && 0 == t('body.material #header-outer[data-condense="true"]').length && d.addClass("transparent"), t("#header-outer.dark-slide.transparent").length > 0 && 0 == t("#boxed").length && 0 == t("body.material-ocm-open").length && d.removeClass("dark-slide").addClass("temp-removed-dark-slide")), t(".slide-out-widget-area-toggle:not(.simple-mobile-menu) > div > a").removeClass("closed").addClass("open").attr("aria-expanded", "true"), t(".slide-out-widget-area-toggle:not(.simple-mobile-menu) > div > a").addClass("animating"), t(e).trigger("nectar-ocm-open"), !1)
        }
        if (e.nectarOcmOpen && a(), r.on("click", ".slide-out-widget-area-toggle:not(.std-menu) a.closed.animating", function() {
                ...
                return !1
            }), r.on("click", ".slide-out-widget-area-toggle:not(.std-menu) a.open:not(.animating), .nectar-ocm-trigger-open a.open, #slide-out-widget-area .slide_out_area_close, > .slide_out_area_close, #slide-out-widget-area-bg.slide-out-from-right, .material-ocm-open #ajax-content-wrap, #ajax-content-wrap.ios-ocm-style-open", function(a) {
                var n;
                if (null != a.originalEvent || 0 != t(".slide_out_area_close.non-human-allowed").length || 0 != t(".slide-out-widget-area-toggle.mobile-icon a.non-human-allowed").length) return !(yt.ocmAnimating || t(".slide-out-widget-area-toggle:not(.std-menu) a.animating").length > 0) && (yt.ocmOpen = !1, d.removeClass("no-transition"), t(this).parents(".simple-mobile-menu").length > 0 ? (Xa("simple-mobile-menu"), t(this).removeClass("open"), !1) : (t(".slide-out-widget-area-toggle:not(.std-menu):not(.simple-mobile-menu) a").removeClass("open").addClass("closed").attr("aria-expanded", "false"), t(".slide-out-widget-area-toggle:not(.simple-mobile-menu):not(.std-menu) a").addClass("animating"), o.hasClass("slide-out-from-right") ? function() {
                    if (0 == t("body.material").length) {
                        var a = ae();
                        bt.winW < 1e3 && (a = !0);
                        var n = e.nectarOptions && e.nectarOptions.mobile_header_format && "centered-menu" === e.nectarOptions.mobile_header_format && a ? "left" : "right";
                        ...
                        o.stop(!0).transition({
                            ...
                            t(".slide-out-widget-area-toggle a").removeClass("animating"), t(this).css({
                                height: "1px",
                                width: "1px"
                            }), 0 == t('#header-outer[data-remove-fixed="1"]').length && (d.hasClass("parallax-contained") && bt.scrollTop > 0 && 0 == t('#header-outer[data-permanent-transparent="1"]').length ? d.removeClass("parallax-contained").addClass("detached").removeClass("transparent") : (0 == bt.scrollTop && t('body[data-hhun="1"]').length > 0 && t('#page-header-bg[data-parallax="1"]').length > 0 || 0 == bt.scrollTop && t('body[data-hhun="1"]').length > 0 && t(".parallax_slider_outer").length > 0) && t('#header-outer[data-transparency-option="1"]').length > 0 && d.addClass("transparent")), t(".container-wrap").css("transform", "none")
                        }), d.removeClass("style-slide-out-from-right"), 0 == t('#header-outer[data-remove-fixed="1"]').length && (1 == pt && 1 == k && bt.winW > 1e3 ? (s.off("scroll.headerResizeEffect"), 0 == bt.scrollTop ? (s.on("scroll.headerResizeEffect", yn), t('#header-outer[data-full-width="true"][data-transparent-header="true"]').length > 0 && f.length > 0 && 1 == pt && t("#header-outer.pseudo-data-transparent").length > 0 && t('#header-outer[data-full-width="true"] header > .container').stop(!0, !0).animate({
                            padding: "0"
                        }, {
                            queue: !1,
                            duration: 250,
                        ...
                        }, 30), t('body[data-hhun="1"] #header-secondary-outer.hidden').removeClass("hidden"), yt.materialOffCanvasOpen = !1, t(e).trigger("nectar-material-ocm-close")
                    ...
                    0 == t(".nectar-social.fixed").length && Jn(), t(".container-wrap").removeClass("no-shadow")
                ...
                }, 1 == pt ? 150 : 50), setTimeout(function() {
                ...
                }, ".fullscreen-inline-images" == n ? 0 : 100)) : t("#header-outer #mobile-menu").length > 0 && Xa("slide-out-widget-area-toggle"), 0 == t("#header-outer #mobile-menu").length && (t("#header-outer.temp-removed-dark-slide.transparent").length > 0 && 0 == t("#boxed").length && d.removeClass("temp-removed-dark-slide").addClass("dark-slide"), 0 == t('#header-outer[data-permanent-transparent="1"]').length && 0 == t("#slide-out-widget-area.fullscreen-alt").length && (0 == t(".nectar-box-roll").length ? (t("#header-outer.small-nav").length > 0 || t("#header-outer.scrolled-down").length > 0) && d.removeClass("transparent") : (t("#header-outer.small-nav").length > 0 || t("#header-outer.scrolled-down").length > 0 || t(".container-wrap.auto-height").length > 0) && d.removeClass("transparent")), d.removeClass("hidden-menu"), d.removeClass("side-widget-open").addClass("side-widget-closed")), t(e).trigger("nectar-ocm-close"), !1))
    ...
    function Qa() {
        (W && r.hasClass("material") && o.hasClass("slide-out-from-right") || e.nectarOptions && "1" === e.nectarOptions.simplify_ocm_mobile && bt.usingMobileBrowser && o.hasClass("slide-out-from-right") && t("body.material").length > 0) && (t("body").attr("data-slide-out-widget-area-style", "slide-out-from-right-hover"), o.removeClass("slide-out-from-right"), o.addClass("slide-out-from-right-hover").addClass("ios-ocm-style"), W && t("body").on("click", "#ajax-content-wrap.ios-ocm-style-open", function() {
            t(".slide-out-widget-area-toggle a").trigger("click")
        }), t("#slide-out-widget-area .inner > .widget").wrapAll('<div class="bottom-meta-wrap"></div>')), t("#slide-out-widget-area.slide-out-from-right-hover").length > 0 ? function() {
            var a = !0;
            ...
            if (bt.usingMobileBrowser || 0 != t(".ios-ocm-style").length) {
                function i() {
                    return a && (Pa(), a = !1, setTimeout(function() {
                        a = !0
                    }, 350)), !1
                }
                r.on("click touchend", ".slide-out-widget-area-toggle:not(.std-menu) a", i), e.nectarOcmOpen && setTimeout(() => {
                    i()
                }, 40), r.on("click", "#slide-out-widget-area-bg", Ra), r.on("click", ".ios-ocm-style .slide_out_area_close", function(t) {
                    Ra(), t.preventDefault()
                })
            } else r.on("mouseenter", "#header-outer .slide-out-widget-area-toggle:not(.std-menu) a", Pa), o.on("mouseenter", function() {
                t(this).addClass("mouse-accessed")
            });
            s.on("smartresize", Ma)
        }() : (Na(), 0 != t("#header-outer #mobile-menu").length && (t("#header-outer #mobile-menu li.megamenu").removeClass("megamenu"), t("#header-outer #mobile-menu ul li a").each(function() {
            ...
            (t(this).find("> ul").length > 0 || t(this).find("> .nectar-global-section-megamenu").length > 0) && t(this).find("> a").append('<span class="sf-sub-indicator"><i class="fa fa-angle-down"></i></span>')
        }), t("#header-outer #mobile-menu").on("click", ".sf-sub-indicator", function() {
            var e = t(this).parent().parent();
            return e.toggleClass("current-open-item"), e.hasClass("current-open-item") ? (e.find("> ul, > .nectar-global-section-megamenu").show(), setTimeout(function() {
                e.addClass("visible")
            }, 30)) : (e.find("ul, .nectar-global-section-megamenu").hide(), e.find("li").removeClass("visible").removeClass("current-open-item"), e.removeClass("visible")), !1
        }), s.on("smartresize", function() {
            (bt.winW > 1e3 && t(".slide-out-widget-area-toggle.mobile-icon a.open").length > 0 || bt.winW > 1e3 && t(".nectar-ocm-trigger-open.simple-mobile-menu a.open").length > 0) && (t(".slide-out-widget-area-toggle.mobile-icon a, .nectar-ocm-trigger-open.simple-mobile-menu a").addClass("non-human-allowed"), t(".slide-out-widget-area-toggle.mobile-icon a.open, .nectar-ocm-trigger-open.simple-mobile-menu a.open").trigger("click"), setTimeout(function() {
    ...
    pe.prototype.setup = function() {
        ...
        this.$el.find(".dynamic-words > span").each(function(e) {
            a.words[e] = t(this)
        }), this.viewportTracking(), this.$el.hasClass("element_stagger_words") && !this.$el.hasClass("delay-js-loaded") ? (this.staggerWaypoint(), t(e).on("nectar-waypoints-reinit nectar-tab-changed", this.staggerWaypoint.bind(this))) : (clearInterval(this.interval), this.interval = setInterval(this.sequence.bind(this), this.duration)), bt.usingMobileBrowser ? e.addEventListener("orientationchange", this.calcWidth.bind(this)) : t(e).on("resize", this.calcWidth.bind(this))
        ...
        "single_link" == this.linkFunc && (t(e).on("resize", this.setVertCenter.bind(this)), this.setVertCenter(), this.$el.find(".wpb_tabs_nav li").on("click", function(e) {
            if (bt.winW < 1e3) {
                ...
                void 0 !== e.originalEvent && (a.$el.find(".scrolling-tab-nav .scrolling-tab-nav-current-item").toggleClass("open"), n.toggle(), Fe()), a.$el.find(".scrolling-tab-nav li").removeClass("active"), t(this).addClass("active"), a.updateActiveTitle()
            }
        }))
        ...
        this.$el.find(".scrolling-tab-nav .menu-item").each(function(a) {
            ...
            if ("default" == e.linkFunc) {
                var s = t(this).html();
                if (i.prepend('<div class="scrolling-tab-mobile-title"><div class="inner">' + Zt(s) + "</div></div>"), i.find(".scrolling-tab-mobile-title a").contents().unwrap(), i) {
        ...
        var n = this;
        if (!(bt.usingMobileBrowser && bt.winW < 1e3) && "IntersectionObserver" in e) {
            ...
            this.observer = new IntersectionObserver(function(e) {
                ...
                e.forEach(function(e) {
                    if (!(bt.winW < 1e3)) {
                        bt.scrollTop > n.prevScroll ? n.scrollDir = "down" : n.scrollDir = "up";
        ...
        bt.winW > 1e3 ? (this.calcTopOffset(), this.$innerEl.css({
            top: this.topOffset
        })) : this.$innerEl.css({
            top: ""
        })
        ...
        1 != yt.materialOffCanvasOpen && 1 != yt.ocmAnimating && (this.offsetTop = this.$element.offset().top, this.height = this.$element.outerHeight(), this.vertCenter = this.storedWinH / 2 - this.height / 2), bt.usingMobileBrowser || (this.storedWinH = bt.winH)
    }, We.prototype.orientationChange = function() {
        bt.usingMobileBrowser && (this.offsetTop = this.$element.offset().top, this.height = this.$element.outerHeight(), this.storedWinH = bt.winH)
    }, We.prototype.trackView = function() {
        var t = this;
        if (this.$element.parents(".top-level").length > 0 && (this.topLevel = !0, this.offsetTop > bt.winH && (this.topLevel = !1)), this.$element.is(".nectar_hook_global_section_parallax_footer") && (this.bottomLevel = !0), "IntersectionObserver" in e) {
            var n = {
                root: Xt() ? null : a,
                rootMargin: "250px"
            };
        ...
        (this.$el.parents("#page-header-bg").length > 0 || this.$el.parents(".featured-media-under-header").length > 0) && (this.type = "page-header"), (this.$el.parents(".top-level").length > 0 && this.$el.parents(".parallax_slider_outer").length > 0 || this.$el.parents(".top-level").length > 0 && this.$el.hasClass("nectar-simple-slider") || this.$el.parents(".top-level").length > 0 && this.$el.hasClass("nectar-recent-posts-single_featured") || this.$el.parents(".top-level").length > 0 && this.$el.hasClass("column-image-bg-wrap") && this.$el.parent().parent().is(".vc_col-sm-12:not(.child_column)") || this.$el.is(".wpb_row.top-level") || "page-header" == this.type || 0 == t(".wpb_row").length && !this.$el.is(".blog_next_prev_buttons") && !this.$el.is("#portfolio-nav")) && (this.firstSection = !0), (0 == t(".wpb_row").length && this.$el.parents(".parallax_slider_outer").length > 0 && this.$el.is('[data-full-width="true"]') || t("#portfolio-extra").length > 0 && this.$el.parents(".parallax_slider_outer").length > 0 && this.$el.parents(".wpb_row").length > 0 && "0" == this.$el.parents(".wpb_row").index()) && (this.firstSection = !0), bt.usingFrontEndEditor && "page-header" != this.type && (this.firstSection = !1), this.$parallaxEl.addClass("translate"), this.nestedParallax = this.$parallaxEl.parents('[data-scroll-animation="true"]').length > 0, this.nestedParallax || setInterval(function() {
            1 != yt.materialOffCanvasOpen && 1 != yt.ocmAnimating && (a.offsetTop = a.$el.offset().top, a.height = a.$el.outerHeight(!0))
        ...
        var t = this,
            e = setInterval(function() {
                1 != yt.materialOffCanvasOpen && (t.offsetTop = t.$el.offset().top, t.height = t.$el.outerHeight(!0))
            }, 30);
        setTimeout(function() {
            clearInterval(e)
        }, 2e3)
    }, Be.prototype.resize = function() {
        bt.usingMobileBrowser ? this.nestedParallax || (this.offsetTop = this.$el.offset().top, this.height = this.$el.outerHeight(!0)) : (this.storedWinH = bt.winH, this.offsetTop = this.$el.offset().top, this.height = this.$el.outerHeight(!0))
    }, Be.prototype.orientationChange = function() {
        bt.usingMobileBrowser && (this.offsetTop = this.$el.offset().top, this.height = this.$el.outerHeight(!0), this.storedWinH = bt.winH)
    }, Be.prototype.update = function() {
        if (this.offsetTop + 150 + this.height < bt.scrollTop || this.offsetTop - 150 > bt.scrollTop + this.storedWinH || 1 == yt.materialOffCanvasOpen) {
            for (var t = 0; t < this.$parallaxEl.length; t++) this.$parallaxEl[t].style.willChange = "auto";
            requestAnimationFrame(this.update.bind(this))
        } else {
            for (t = 0; t < this.$parallaxEl.length; t++) !0 === this.firstSection ? this.$parallaxEl[t].style.transform = "translate3d(0, " + bt.scrollTop * this.speed + "px, 0)" : this.$parallaxEl[t].style.transform = "translate3d(0, " + (this.storedWinH + bt.scrollTop - this.offsetTop) * this.speed + "px, 0) scale(1.005)", this.$parallaxEl[t].style.willChange = "transform";
            requestAnimationFrame(this.update.bind(this))
        }
    }, t(e).on("salient-parallax-el-recalculate", Fe), Le.prototype.setupProps = function() {
        ...
        var t = this;
        if (!bt.usingFrontEndEditor && "IntersectionObserver" in e && !this.$el.hasClass("skip-lazy-init")) {
            t = this;
            var n = new IntersectionObserver(function(e) {
                e.forEach(function(e) {
                    e.isIntersecting && (t.init(), n.unobserve(e.target))
        ...
        this.offsetTop = t.top + bt.scrollTop, this.elHeight = this.$el[0].offsetHeight, this.setActiveDevice()
    }, Le.prototype.orientationChange = function() {
        if (bt.usingMobileBrowser) {
            var t = this.$el[0].getBoundingClientRect();
            this.offsetTop = t.top + bt.scrollTop, this.elHeight = this.$el[0].offsetHeight, this.storedWinH = bt.winH
        }
    }, Le.prototype.setActiveDevice = function() {
        var t = this;
        Object.keys(this.devices).forEach(function(e) {
            bt.winW >= t.devices[e].min && bt.winW <= t.devices[e].max && (t.activeDevice = e, void 0 !== t.timelines[e] && t.timelines[e].reset())
        })
        ...
        1 != yt.materialOffCanvasOpen && 1 != yt.ocmAnimating && this.progressValues(), requestAnimationFrame(this.update.bind(this))
    }, t(e).on("salient-parallax-bg-recalculate", Ye), Ge.prototype.calculatePos = function() {
        1 != yt.materialOffCanvasOpen && 1 != yt.ocmAnimating && (this.offsetTop = this.$element.offset().top, this.height = this.$element.outerHeight(), this.vertCenter = bt.winH / 2 - this.height / 2)
        ...
        if (1 != yt.materialOffCanvasOpen) {
            if (1 == yt.animatedScrolling && (this.inView = !0), this.lastY = Dt(this.lastY, bt.scrollTop, .2), this.inView) {
                var a = this;
                this.$element.find(".bg-layer").each(function(e) {
                    var n = t(this).data("scale");
                    a.layer1Parallax && (e = e / 1.5 + 1), !0 === a.topLevel && bt.winW > 1e3 ? t(this)[0].style.transform = "translateY(" + -a.lastY * a.intensity * e + "px) translateZ(0) scale(" + n + ")" : t(this)[0].style.transform = "translateY(" + -(a.lastY - a.offsetTop + a.vertCenter) * a.intensity * e + "px) translateZ(0) scale(" + n + ")"
                })
            }
            e.requestAnimationFrame(this.animate.bind(this))
        } else e.requestAnimationFrame(this.animate.bind(this))
        ...
        bt.usingMobileBrowser ? e.addEventListener("orientationchange", this.calc.bind(this)) : e.addEventListener("resize", this.calc.bind(this)), this.calc()
    }, Je.prototype.calc = function() {
        this.offsetTop = this.$el.offset().top, this.elHeight = this.$el.outerHeight(), this.wordCount = this.mergedGroup ? this.$el.find(".nectar-split-heading .inner").length : this.$el.find(".inner").length, this.elHeight / bt.winH < .25 && this.wordCount < 40 ? this.speed = 2.5 : (this.speed = Math.max(2 - Math.min(this.elHeight / bt.winH, 1.45), .66), (this.speed < 1.2 || this.wordCount < 30 && this.speed < 1.5) && (this.topCushion = .25 * bt.winH, this.wordDelay = 250));
        var t = this.$el.find('.nectar-split-heading[data-text-effect="scroll-opacity-reveal"]').attr("data-animation-offset");
        t && parseInt(t) > 0 && parseInt(t) < 100 && (t = parseInt(t), this.topCushion = .05 * bt.winH + .05 * bt.winH * (1 - t / 100) * 6)
        ...
        var t;
        this.inView && 1 != yt.materialOffCanvasOpen ? (t = this.topLevel ? bt.scrollTop / bt.winH * 1.5 : 1 + (bt.scrollTop - (this.offsetTop + this.topCushion)) / bt.winH, this.timeline.seek(t * this.timeline.duration * this.speed), requestAnimationFrame(this.raf.bind(this))) : requestAnimationFrame(this.raf.bind(this))
    }, t(e).on("salient-lazyloading-image-reinit", ca), t(e).on("salient-lazyloading-image-reinit", ha), fa.prototype.initialMarkup = function() {
        if (0 == this.el.find(".nectar-post-grid-filters a.active").length && this.el.find(".nectar-post-grid-filters a:first-child").addClass("active"), "load-more" === this.settingsData.pagination && 0 == this.el.find(".load-more-wrap").length) {
            ...
            "rand" == n.orderby && "load-more" == c && (f.posts_shown = "", l.find(".nectar-post-grid-item[data-post-id]").each(function() {
                ...
                if ("load-more" === c) l.append(n);
                    ...
                    var r = l.parent().offset().top,
                        h = 0;
                    0 == t(".page-template-template-no-header-footer").length && 0 == t(".page-template-template-no-header").length && 0 == t('body[data-header-format="left-header"]').length && (h = t("#header-outer").height()), bt.winW > 999 && bt.scrollTop > r + 200 && e.scrollTo(0, r - h)
                }
                ke(), l.is("[data-animation]") && !l.is('[data-animation="none"]') && (o.parents(".nectar-post-grid-wrap").removeClass("finished-animating"), l.find(".nectar-post-grid-item:not(.animated-in)").each(function(e) {
                    t(this).find(".nectar-split-heading").length > 0 && qn(t(this).find(".nectar-split-heading"));
                    var n = t(this);
                    setTimeout(function() {
                        n.addClass("animated-in"), "zoom-out-reveal" === a.animation && Fn(n, function() {
                            Ln(n)
                        })
                    }, 90 * e)
                }), setTimeout(function() {
        ...
        void 0 !== re["grid-filter"] && this.el.find(".nectar-post-grid-filters a").each(function() {
            var e = t(this).clone(),
                a = re["grid-filter"];
            t(this);
        ...
        _config: function() {
            this.open = !1, this.$trigger = this.$el.children(".trigger"), this.$menu = this.$el.children("ul.menu"), this.$menuitems = this.$menu.find("li:not(.back) > a"), this.$el.find(".sub-menu").prepend('<li class="back"><a href="#"> ' + o.attr("data-back-txt") + " </a></li>"), this.$back = this.$menu.find("li.back")
        },
            ...
            this.$trigger.on("click.menu", function() {
                ...
                if (t(".fullscreen-alt .off-canvas-menu-container .clip-wrap, .fullscreen-alt .off-canvas-menu-container .clip-wrap span").css("transition-duration", "0s"), i.length > 0) {
                    ...
                    return setTimeout(function() {
                        ...
                        height: s.height()
                    }, 500, "easeInOutQuad"), setTimeout(qa, 600), !1
                }
                ...
                return setTimeout(function() {
                    ...
                    }, 500, "easeInOutQuad"), setTimeout(qa, 600)
                }, 50), !1
            })
        },
        closeMenu: function() {
    ...
    function tn() {
        ...
        if (t('#page-header-bg[data-parallax="1"]').length > 0) {
            ...
            c && -1 !== c.indexOf(".") ? (r.onload = function() {
                Ka()
            }, r.src = ne(t('#page-header-bg[data-parallax="1"]').css("background-image"))) : Ka(), bt.winW > 1e3 && p(), e.addEventListener("scroll", function() {
        ...
        if (g.length > 0) {
            ...
            u && -1 !== u.indexOf(".") && g.addClass("has-bg"), s.on("smartresize", Ja)
        }

        function p() {
            bt.winW >= 1e3 && null == navigator.userAgent.match(/iPad/i) && 1 != yt.materialOffCanvasOpen && (1 == a.inView && (n.css({
                transform: "translateY(" + .15 * bt.scrollTop + "px)",
                opacity: 1 - bt.scrollTop / (.7 * (d + o))
            }), i && i.css({
                transform: "translateY(" + .15 * bt.scrollTop * 2 + "px)"
            })), bt.scrollTop / (o + l + bt.adminBarHeight) > 1 ? (a.inView = !1, t(".nectar-particles, #page-header-bg .fade-out").css("visibility", "hidden").addClass("out-of-sight"), t("#page-header-bg").addClass("out-of-sight")) : (a.inView = !0, t("#page-header-bg, .nectar-particles, #page-header-bg .fade-out").css("visibility", "visible").removeClass("out-of-sight")))
        }
        g.length > 0 && ((-1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome") || navigator.userAgent.match(/(iPod|iPhone|iPad)/)) && (e.onunload = function() {
            tn(), t('#page-header-bg[data-parallax="1"] .span_6').css({
                opacity: 1
            })
    ...
    function an() {
        ...
        0 == t("#page-header-bg .nectar-video-wrap video").length && setTimeout(en, e)
    }
    ...
    function sn() {
        t(".nectar-box-roll").length > 0 && "undefined" != typeof NectarBoxRoll && (an(), t(e).on("nectar-box-roll-scroll-disabled", function() {
            yt.preventScroll = !0
    ...
    function rn() {
        ...
        a = 1 == ut ? "500%" : "93%", i = 1 == ut ? "500%" : "95%", t(ht + '.row-bg-wrap[data-bg-animation]:not([data-bg-animation="none"]) .row-bg').each(function() {
            ...
            }), l = 1 == ut ? "500%" : "93%", c = 1 == ut ? "500%" : "80%", t(ht + '.column-image-bg-wrap[data-bg-animation]:not([data-bg-animation="none"]) .column-image-bg').each(function() {
                var e = t(this).parents(".column-image-bg-wrap").attr("data-bg-animation");
                o = "zoom-out-reveal" != e && -1 == e.indexOf("reveal-from-") ? l : "ro-reveal-from-bottom" == e && 0 == ut ? "95%" : "ro-reveal-from-top" == e && 0 == ut ? "65%" : c;
                var a = t(this),
                    n = new Waypoint({
            ...
            }), Qe(), Ke(), na(), h = 1 == ut ? "250%" : "75%", t(ht + '.nectar-icon-list[data-animate="true"]').each(function() {
                var e = t(this),
                    a = new Waypoint({
                        element: e[0],
                        handler: function() {
            ...
            }), ma(), va(), ra(), u = 1 == ut ? "200%" : "95%", t(ht + ".clients.fade-in-animation").each(function() {
                var e = t(this),
                    a = new Waypoint({
                        element: e[0],
                        handler: function() {
            ...
            }), Ue(), p = 1 == ut ? "500%" : "bottom-in-view", 0 == q.length || bt.usingFrontEndEditor && t("#nectar_fullscreen_rows").length > 0 ? (t(".svg-icon-holder:not(.animated-in)").has("svg").each(function(e) {
                var a = t(this);
                ...
                if ("false" == a.attr("data-animation") && (n = 1, a.css("opacity", "1")), a.hasClass("bound") || (q[e] = new Vivus(a.find("svg").attr("id"), {
                        type: "delayed",
                ...
                function s() {
                    ...
                    1 == q[e].isReady ? setTimeout(function() {
                ...
                clearTimeout(n), n = setTimeout(function() {
                    q.length > 0 && t(".svg-icon-holder.animated-in").each(function() {
                ...
                clearTimeout(st[e]), "false" == n.attr("data-animation") ? (n.css("opacity", "1"), q[i].finish()) : t(this).parents(".active").length > 0 || t(this).parents("#footer-outer").length > 0 || t("body.mobile").length > 0 ? (q[i].reset(), st[e] = setTimeout(function() {
                    q[i].play()
                }, a)) : q[i].reset().stop()
            }),
            function() {
                if (t(".nectar-milestone").each(function() {
                        var e;
                        t(this).is("[data-symbol]") && (0 == t(this).find(".symbol-wrap").length && ("before" == t(this).attr("data-symbol-pos") ? t(this).find(".number").prepend('<div class="symbol-wrap"><span class="symbol">' + Zt(t(this).attr("data-symbol")) + "</span></div>") : t(this).find(".number").append('<div class="symbol-wrap"><span class="symbol">' + Zt(t(this).attr("data-symbol")) + "</span></div>")), e = t(this).attr("data-symbol-size") == t(this).find(".number").attr("data-number-size") && "superscript" == t(this).attr("data-symbol-alignment") ? 32 : parseInt(t(this).attr("data-symbol-size")), t(this).find(".symbol-wrap").css({
                            "font-size": e + "px",
                            "line-height": e + "px"
                    ...
                    }), de(e, "milestone-blur"), fe()
                }
            }(), Oe(), t(ht + '.owl-carousel[data-enable-animation="true"]').each(function() {
            ...
            function() {
                if (t('body[data-header-inherit-rc="true"]').length > 0 && 0 == t(".mobile").length && t('#header-outer[data-transparent-header="true"]').length > 0) {
                    ...
                    0 == t('#header-outer[data-permanent-transparent="1"]').length && (e = w - _ + Math.ceil(2 * y / 1.8) + bt.adminBarHeight), t(".main-content > .row > .wpb_row, #full_width_portfolio #portfolio-extra > .wpb_row").each(function() {
                        var a, n = t(this);
                        new Waypoint({
                            element: n[0],
                            handler: function(e) {
            ...
            function() {
                ...
                dt = [], t(".nectar-rotating-words-title").each(function(e) {
    ...
    function on() {
        var a;
        kt(), It(), setTimeout(Et, 100), St(), Bt(), Pt(), Yt(), Vt(), ye(), r.on("click", ".toggle > h3 a, .toggle > .toggle-title a", function() {
                ...
                if (0 == t(this).parents('.toggle[data-inner-wrap="true"]').length) i.find(".toggle > div").slideUp(300), i.find(".toggle h3 a i").attr("class", "fa fa-plus-circle"), i.find(".toggle").removeClass("open"), r.find("> div").slideDown(300), r.addClass("open");
                    ...
                    void 0 !== a.originalEvent && bt.winW < 1e3 && i.find(".toggle.open").length > 0 && 0 == mt.$usingFullScreenRows && (i.find(".toggle.open"), setTimeout(function() {
                        var e = r.offset().top - bt.adminBarHeight;
                        t('#header-outer[data-mobile-fixed="1"]').length > 0 && (e = r.offset().top - d.outerHeight() - bt.adminBarHeight), ee(e, 0, "easeInOutQuint")
                    }, 50));
                    var o = r.find("> div")[0];
            ...
            }), $e(), $a(), ke(), r.on("click", '.nectar-cta:not([data-style="material"]) .link_wrap', function(e) {
                ...
                if (!(t(".nectar_team_member_overlay").length > 0)) {
                    ...
                    t(".nectar_team_member_overlay .inner-wrap").css({
                        "padding-top": u
                    }), t(".using-mobile-browser").length > 0 && t("body,html").addClass("nectar-no-scrolling"), Te(), t(".nectar_team_member_overlay").addClass("open").addClass("animating"), setTimeout(function() {
                        t(".nectar_team_member_close").addClass("visible"), t(".nectar_team_member_overlay").removeClass("animating")
                    }, 500), t('.team-member[data-style="bio_fullscreen"]').length > 0 && bt.usingMobileBrowser && t(".nectar_team_member_overlay").addClass("on-mobile"), Ea(), t(e).trigger("nectar-team-member-opened")
                }
            ...
            }), (t('.team-member[data-style="bio_fullscreen"]').length > 0 || t('.team-member[data-style="bio_fullscreen_alt"]').length > 0) && (s.on("resize", Te), !bt.usingMobileBrowser)) && new $t("", "close-indicator"), t(".nectar-flip-box").length > 0 && (bt.usingMobileBrowser && r.on("click", ".nectar-flip-box", function() {
                t(this).toggleClass("flipped")
            }), He(), s.on("smartresize", He)), Ft(), Xe(), Ne(), ze(), Nn(), Qn(), De(), t(".morphing-outline").length > 0 && (setTimeout(Ee, 100), setTimeout(Ve, 125), s.on("smartresize", Ee)), V = [], bt.usingMobileBrowser || t("[data-nectar-link-indicator]").each(function(e) {
                t(this).is("[data-indicator-text]") ? V[e] = new $t(t(this), "view-indicator") : V[e] = new $t(t(this), "link-indicator")
            }), pa(), t(".nectar_cascading_images").length > 0 && (Q = [], t(".nectar_cascading_images").each(function(e) {
                imagesLoaded(t(this), function(a) {
                    Ze(), t(a.elements[0]).is('[data-parallax="yes"]') && !bt.usingMobileBrowser && 0 == t("#nectar_fullscreen_rows").length && (Q[e] = new Ge(t(a.elements[0]), t(a.elements[0]).attr("data-parallax-intensity")))
                })
            }), s.on("resize", Ze)), sa(), wa(),
            function() {
                t('.page-submenu[data-sticky="true"]').length > 0 && 0 == t("#nectar_fullscreen_rows").length && (! function() {
                    ...
                    s.on("smartresize", function() {
                        if (n = Gt(), u.length > 0 && "fixed" == u.css("position") && (n += u.height()), (f.length > 0 && s.width() > 1e3 && t('body[data-hhun="1"]').length > 0 || f.length > 0 && t('body[data-hhun="1"]').length > 0 && B) && (W || (n += f.height())), t(".page-submenu.stuck").length > 0) {
                        ...
                        n = Gt(), this.topLevel && t('body[data-hhun="1"] #header-outer.detached:not(.invisible)').length > 0 && (n += 1, this.$element.css({
                            "margin-top": "-1px"
                        })), u.length > 0 && "fixed" == u.css("position") && (n += u.height()), (f.length > 0 && s.width() > 1e3 && t('body[data-hhun="1"]').length > 0 || f.length > 0 && B && t('body[data-hhun="1"]').length > 0) && (W || (n += f.height())), this.waypoint = new a(t.extend({}, this.options, {
                            ...
                            handler: t.proxy(function(a) {
                                ...
                                if (this.$wrapper.height(r), i) {
                                    ...
                                    if (this.topLevel && t('body[data-hhun="1"] #header-outer.detached:not(.invisible)').length > 0) {
                                        var l = d.outerHeight(),
                                            h = 0;
                                        c.length > 0 && (l -= bt.secondaryHeaderHeight), f.length > 0 && 0 == t("body.mobile").length && (h = pt ? f.height() : 0), o = l - h
                                    }
                        ...
                        setInterval(function() {
                            if (t('body[data-hhun="1"] #header-outer.detached:not(.invisible)').length > 0) {
                                var e = d.outerHeight();
                                c.length > 0 && (e -= bt.secondaryHeaderHeight), i.waypoint.options.offset = n + e
            ...
            }(), K = [], "undefined" == typeof NectarLiquid || bt.usingFrontEndEditor || t('.row-bg-wrap[data-bg-animation*="displace-filter"] .row-bg.using-image, .column-image-bg-wrap[data-bg-animation*="displace-filter"] .column-image-bg').each(function(e) {
                var a, n, i = t(this);
                t(this).is(".row-bg") ? (a = t(this).parents(".row-bg-wrap").attr("data-bg-animation"), n = "row") : t(this).is(".column-image-bg") && (a = t(this).parents(".column-image-bg-wrap").attr("data-bg-animation"), n = "col"), K[e] = new NectarLiquid(i, a, n)
            }), ya(),
            function() {
                function e() {
            ...
            }(), Vn(), Xn(), Gn(), r.on("mouseover", '.post-area.featured_img_left .grav-wrap .text a, .masonry.material .masonry-blog-item .grav-wrap .text a, .blog-recent[data-style="material"] .grav-wrap .text a', function() {
            ...
            }(), Pn(), t(".nectar-scrolling-text").each(function() {
    ...
    function hn() {
        ...
        if (t("#header-outer .nectar-woo-cart").length > 0 && t("#header-outer .nectar-woo-cart").hoverIntent(function() {
                ...
                if (0 != t("body.woocommerce-account #customer_login").length) {
                    ...
                    var a = "1";
                    if (void 0 !== re.tab && "2" === re.tab && (a = "2", e.history && e.history.replaceState && "function" == typeof URL)) {
            ...
            }(), !(t('.products[data-rm-m-hover="1"]').length > 0 && bt.usingMobileBrowser) && (r.on("mouseover", ".text_on_hover .product-wrap, .text_on_hover > a:first-child", function() {
        ...
        if (t(".products .classic .product-wrap .add_to_cart_button").wrapInner("<span />"), t(".products .classic .product-wrap .add_to_cart_button").prepend('<i class="normal icon-salient-cart"></i>'), !(t('.products[data-rm-m-hover="1"]').length > 0 && bt.usingMobileBrowser) && e.nectarOptions && e.nectarOptions.woo_minimal_product_effect && "default" === e.nectarOptions.woo_minimal_product_effect && (r.on("mouseover", ".products .minimal.product", function() {
                ...
                return t(".nectar-slide-in-cart, .nectar-slide-in-cart-bg").addClass("open"), t(".nectar-slide-in-cart-bg").addClass("revealed"), clearTimeout(Ga), t(".style_slide_in_click div.quantity").each(function() {
                    t(this).find(".minus").length > 1 && t(this).find(".minus").first().remove(), t(this).find(".plus").length > 1 && t(this).find(".plus").first().remove()
                }), !1
            }), r.on("click", ".nectar-slide-in-cart.style_slide_in_click .close-cart, .nectar-slide-in-cart-bg", un), new dn, e.nectarOptions && "1" === e.nectarOptions.ajax_add_to_cart) new cn;
        if (e.nectarOptions && "1" === e.nectarOptions.woo_product_filter_toggle && r.is(".archive.woocommerce")) new ln;
        t(a).on("yith-wcan-ajax-filtered", ca)
    }

    function un() {
        return t(".nectar-slide-in-cart, .nectar-slide-in-cart-bg").removeClass("open"), Ga = setTimeout(function() {
    ...
    function fn() {
        t('#header-outer[data-format="centered-menu-bottom-bar"]').length > 0 && function() {
            ...
            function p() {
                ae() ? d.addClass("within-custom-breakpoint") : d.removeClass("within-custom-breakpoint")
            }

            function g() {
                if (!(bt.winW < 1e3 || t("body.page-template-template-no-header").length > 0 || t("body.page-template-template-no-header-footer").length > 0 || t("body.material-ocm-open").length > 0 || "none" == t('#header-outer[data-has-menu="true"][data-format="centered-menu-bottom-bar"] .span_9').css("display") || "none" == t('#header-outer[data-has-menu="true"][data-format="centered-menu-bottom-bar"] .span_9 > nav').css("display")))
                    if (f = f.length > 0 && bt.secondaryHeaderHeight > 0 ? f.height() : 0, e.hasClass("force-condense") || !e.hasClass("fixed-menu") && bt.scrollTop >= u) {
                        var n = parseInt(a.position().top) - o - parseInt(bt.adminBarHeight) + parseInt(bt.secondaryHeaderHeight) - f;
                    ...
                    } else(e.hasClass("force-condense-remove") || e.hasClass("fixed-menu") && bt.scrollTop < u) && (e.removeClass("fixed-menu").css({
                        top: "0",
                        position: "absolute"
            ...
            i.length > 0 && 0 == t('#header-outer[data-remove-fixed="1"]').length && t('#header-outer[data-condense="true"]').length > 0 && setTimeout(function() {
                "none" != c.css("display") && (bt.secondaryHeaderHeight = c.outerHeight())
            }, 50), t('#header-outer[data-condense="true"]').length > 0 && (s.on("scroll.centeredNavCondense", g), s.trigger("scroll"), s.on("resize", function() {
                (bt.winW < 1e3 || ae()) && (e.addClass("force-condense-remove"), s.off("scroll.centeredNavCondense"))
            }), s.on("smartresize", function() {
                p(), bt.winW >= 1e3 && 0 == ae() && e.hasClass("force-condense-remove") && (g(), e.removeClass("force-condense-remove"), setTimeout(function() {
                    bt.scrollTop >= u && (e.addClass("force-condense"), g(), e.removeClass("force-condense")), s.on("scroll.centeredNavCondense", g)
                }, 200))
            }), p())
        }()
    }
    ...
    function gn() {
        ...
        } else t('#header-outer[data-format="centered-logo-between-menu"]').length > 0 && bt.winW < 1e3 && t("#header-outer .row > .col.span_9").css({
            "padding-right": "0",
            "padding-left": "0"
        })
    }
    ...
    function vn() {
        t("#nectar_fullscreen_rows").length > 0 && 1 == ut && d.attr("data-permanent-transparent", "false"), bt.usingMobileBrowser && t('#header-outer[data-mobile-fixed="1"]').length > 0 && 0 == t('#header-outer[data-transparent-header="true"]').length && t("#header-space").css("height", d.outerHeight()).addClass("calculated"), e.nectarOptions && e.nectarOptions.header_entrance && "true" == e.nectarOptions.header_entrance && (0 == bt.scrollTop ? t("#header-outer").addClass("entrance-animation") : t("#header-outer").css("opacity", "1")), 0 == t("#nectar_fullscreen_rows").length && 0 == t(".nectar-box-roll").length ? nn() : t("#nectar_fullscreen_rows").length > 0 && 0 == ut && nn()
    }
    t.fn.dlmenu = function(e) {
        if ("string" == typeof e) {
            ...
            this.each(function() {
                ...
                n ? t.isFunction(n[e]) && "_" !== e.charAt(0) ? n[e].apply(n, a) : Ua("no such method '" + e + "' for menu instance") : Ua("cannot call methods on menu prior to initialization; attempted to call method '" + e + "'")
            })
        ...
        this.$sidebar.hasClass("open") && bt.winW > 999 && (this.$sidebar.removeClass("open"), this.$sidebar.find(".nectar-close-btn-wrap").removeClass("open"), t(".container-wrap").css("z-index", "11"))
        ...
        this.request = t.ajax({
            ...
            success: function(e) {
                ...
                }, 200), bt.winW >= 1e3 && !d.hasClass("results-shown") && (a.$container.find(".product, .search-post-item").css({
                    opacity: "0",
    ...
    function wn() {
        ...
        bn.bodyOffsetHeight = a.body.offsetHeight, 0 == bn.init && setInterval(function() {
            1 != yt.materialOffCanvasOpen && (bn.bodyOffsetHeight = a.body.offsetHeight)
        }, 1500), bn.raf = requestAnimationFrame(function a() {
            d[0].classList.add("detached");
            var o = bt.scrollTop,
                l = Math.abs(o - e);
            if (1 == yt.animatedScrolling || 1 == yt.preventScroll || 1 == yt.ocmOpen) return o > n && (1 == yt.animatedScrolling && 1 == $ && 0 == yt.permanentTransHeader && d.removeClass("transparent").addClass("scrolling"), e = bt.scrollTop, o = bt.scrollTop), void(bn.raf = requestAnimationFrame(a));
            if (1 == yt.materialOffCanvasOpen || 1 == yt.materialSearchOpen) return 1 == yt.materialSearchOpen && 1 == $ && (0 == yt.permanentTransHeader && o > n ? d.removeClass("transparent").addClass("scrolling") : d.addClass("transparent").removeClass("scrolling")), void(bn.raf = requestAnimationFrame(a));
            if (!d.hasClass("side-widget-open") && !t("#header-outer .slide-out-widget-area-toggle a").hasClass("animating")) {
                var h;
                if (c.length > 0 && (o > n ? (c.addClass("hide-up"), d.css("transform", "translateY(-" + bt.secondaryHeaderHeight + "px)")) : (c.removeClass("hide-up"), d.css("transform", "0px)"))), o > n) 0 == yt.permanentTransHeader && (0 == bn.timeoutQueued && setTimeout(function() {
                    0 == yt.ocmOpen && (d.removeClass("transparent"), d.addClass("scrolling")), bn.timeoutQueued = !1
                }, 400), bn.timeoutQueued = !0), d.removeClass("no-transition"), l >= s && (o > e ? (d.hasClass("invisible") || (d.addClass("invisible").removeClass("at-top"), bt.winW > 1e3 && t(".sf-menu").length > 0 && t().superfish && (t(".sf-menu").superfish("hide"), t("header#top nav > ul.sf-menu > li.menu-item-over").removeClass("menu-item-over"))), 1 == r && t(".page-submenu.stuck").css("transform", "translateY(0px)").addClass("header-not-visible")) : (d.hasClass("invisible") && d.removeClass("invisible"), 1 == r && (h = d.outerHeight(), c.length > 0 && (h -= bt.secondaryHeaderHeight), f.length > 0 && bt.winW > 999 ? (i = pt ? f.height() : 0, t(".page-submenu.stuck").css("transform", "translateY(" + (h - i) + "px)").removeClass("header-not-visible")) : t(".page-submenu.stuck").css("transform", "translateY(" + h + "px)").removeClass("header-not-visible"))));
                else {
                    var u = c.length > 0 ? 32 : 0;
                    M && (u += 10), f.length > 0 && (u = c.length > 0 ? 32 + f.height() : f.height()), o <= u && (d.addClass("at-top").removeClass("invisible").removeClass("scrolling"), bt.winW > 999 && t('#header-outer[data-megamenu-rt="1"]').length > 0 && 1 == $ && t("#header-outer .megamenu").length > 0 ? 0 == t(".nectar-box-roll").length && 0 == t(".megamenu.sfHover:not(.width-75):not(.width-50)").length ? d.addClass("transparent").css("transform", "translateY(0)").removeClass("no-transition") : t(".nectar-box-roll").length > 0 && d.css("transform", "translateY(0)").addClass("at-top-before-box") : 1 == $ && 0 == gt.inUse ? d.addClass("transparent").css("transform", "translateY(0)") : 1 == gt.inUse && d.css("transform", "translateY(0)").addClass("at-top-before-box"))
                }
                bt.winH + bt.scrollTop + 30 >= bn.bodyOffsetHeight && (d.removeClass("invisible"), 1 == r && (h = d.outerHeight(), c.length > 0 && (h -= bt.secondaryHeaderHeight), f.length > 0 && bt.winW > 999 ? (i = pt ? f.height() : 0, t(".page-submenu.stuck").css("transform", "translateY(" + (h - i) + "px)").removeClass("header-not-visible")) : t(".page-submenu.stuck").css("transform", "translateY(" + h + "px)").removeClass("header-not-visible")))
            }
    ...
    function yn() {
        var e = bt.scrollTop,
            a = bt.winW,
            n = 30;
        1 != $ || bt.usingMobileBrowser || (n = M ? 30 : 0), e > n && a >= 1e3 && 0 == t("body.material-ocm-open").length && (r.is(".material") && (0 == t("#search-outer.material-open").length && t('#header-outer[data-transparent-header="true"] .bg-color-stripe').css("transition", "none"), c.length > 0 && (c.addClass("hide-up"), d.css("transform", "translateY(-" + bt.secondaryHeaderHeight + "px)"))), t('#header-outer[data-megamenu-rt="1"]').length > 0 && t('#header-outer[data-transparent-header="true"]').length > 0 && t("#header-outer .megamenu").length > 0 ? "true" == d.attr("data-transparent-header") && 0 == t("#header-outer.side-widget-open").length && 0 == t('#header-outer[data-permanent-transparent="1"]').length && 0 == t(".megamenu.sfHover:not(.width-75):not(.width-50)").length && (d.removeClass("transparent"), d.removeClass("no-transition")) : "true" == d.attr("data-transparent-header") && 0 == t("#header-outer.side-widget-open").length && 0 == t('#header-outer[data-permanent-transparent="1"]').length && d.removeClass("transparent"), t("#header-outer:not(.small-nav) header#top nav > ul > li.menu-item-with-margin").stop(!0, !0).animate({
            "margin-right": parseInt(t("header#top nav > ul > li.menu-item-with-margin").css("margin-right")) - 3 * parseInt(_) + "px"
        }, {
            queue: !1,
            duration: 250,
            easing: "easeOutCubic"
        }), t("#header-outer, #search-outer").addClass("small-nav"), t('#header-outer[data-full-width="true"][data-transparent-header="true"]').length > 0 && f.length > 0 && 1 == pt && t('#header-outer[data-full-width="true"] header > .container').stop(!0, !0).animate({
            padding: "0"
        }, {
            queue: !1,
            duration: 250,
            ...
            "margin-top": Math.floor(w - _ + 2 * y / 1.8 + bt.adminBarHeight + bt.secondaryHeaderHeight)
        }, {
            queue: !1,
            duration: 250,
            easing: "easeOutCubic"
    ...
    function _n() {
        ...
        1 != $ || bt.usingMobileBrowser || (n = M ? 30 : 0), (e <= n && a >= 1e3 || t(".small-nav").length > 0 && t("#ajax-content-wrap.no-scroll").length > 0) && (t("#header-outer, #search-outer").removeClass("small-nav"), t('#header-outer[data-megamenu-rt="1"]').length > 0 && t('#header-outer[data-transparent-header="true"]').length > 0 && t("#header-outer .megamenu").length > 0 ? "true" == d.attr("data-transparent-header") && 0 == t(".nectar-box-roll").length && 0 == t(".megamenu.sfHover:not(.width-75):not(.width-50)").length && (d.addClass("transparent"), d.removeClass("no-transition")) : "true" == d.attr("data-transparent-header") && 0 == t(".nectar-box-roll").length && d.addClass("transparent"), t('#header-outer[data-full-width="true"][data-transparent-header="true"]').length > 0 && f.length > 0 && 1 == pt && t('#header-outer[data-full-width="true"] header > .container').stop(!0, !0).animate({
            padding: "0 28px"
        }, {
            queue: !1,
            duration: 250,
            ...
            "margin-top": Math.floor(w + 2 * y + bt.adminBarHeight + bt.secondaryHeaderHeight)
        }, {
            queue: !1,
            duration: 250,
            easing: "easeOutCubic"
    ...
    function Cn() {
        t('#header-outer[data-format="centered-menu-bottom-bar"][data-condense="true"]').length > 0 && !d.hasClass("within-custom-breakpoint") || bt.scrollTop > 0 && (t("body.material").length > 0 && (d.addClass("scrolled-down"), c.length > 0 && bt.winW > 1e3 && (c.addClass("hide-up"), d.css("transform", "translateY(-" + bt.secondaryHeaderHeight + "px)"))), "true" == d.attr("data-transparent-header") && 0 == t('#header-outer[data-permanent-transparent="1"]').length && d.removeClass("transparent").addClass("scrolled-down"), s.off("scroll.headerResizeEffectOpaque", Cn), s.on("scroll.headerResizeEffectOpaque", xn))
    }

    function xn() {
        t('#header-outer[data-format="centered-menu-bottom-bar"][data-condense="true"]').length > 0 && !d.hasClass("within-custom-breakpoint") || 0 == bt.scrollTop && 0 == t("body.material-ocm-open").length && (t('#header-outer[data-megamenu-rt="1"]').length > 0 && t('#header-outer[data-transparent-header="true"]').length > 0 && t("#header-outer .megamenu").length > 0 ? "true" == d.attr("data-transparent-header") && 0 == t(".megamenu.sfHover:not(.width-75):not(.width-50)").length ? (d.addClass("transparent").removeClass("scrolled-down"), d.removeClass("no-transition")) : "true" == d.attr("data-transparent-header") && d.removeClass("scrolled-down") : "true" == d.attr("data-transparent-header") && d.addClass("transparent").removeClass("scrolled-down"), t("body.material").length > 0 && (d.removeClass("scrolled-down"), c.length > 0 && bt.winW > 1e3 && (c.removeClass("hide-up"), d.removeClass("hide-up").css("transform", "translateY(0%)"))), s.off("scroll.headerResizeEffectOpaque", xn), s.on("scroll.headerResizeEffectOpaque", Cn))
    }

    function kn() {
        1 != yt.materialOffCanvasOpen ? (bt.scrollTop > 5 ? "scrolled" != yt.mobileHeader && (0 == yt.permanentTransHeader && d.removeClass("transparent"), bt.secondaryHeaderHeight > 0 ? (c.addClass("hide-up"), d.css("transform", "translateY(-" + bt.secondaryHeaderHeight + "px)").addClass("hidden-secondary")) : d.removeClass("hidden-secondary"), d.addClass("scrolled-down"), yt.mobileHeader = "scrolled") : "at-top" != yt.mobileHeader && ("true" == d.attr("data-transparent-header") && d.addClass("transparent"), bt.secondaryHeaderHeight > 0 && (c.removeClass("hide-up"), d.css("transform", "translateY(0px)")), d.removeClass("hidden-secondary").removeClass("scrolled-down"), yt.mobileHeader = "at-top"), bt.winW < 1e3 && requestAnimationFrame(kn)) : requestAnimationFrame(kn)
    }

    function $n() {
        bt.winW > 999 || (yt.mobileHeader = "", s.off("scroll.headerResizeEffect"), s.off("scroll.headerResizeEffectOpaque"), "1" == I && t('#header-outer[data-mobile-fixed="1"]').length > 0 ? (t(".nectar-box-roll").length > 0 && d.addClass("at-top-before-box"), cancelAnimationFrame(bn.raf), bn.timeoutQueued = !1, wn()) : t('#header-outer[data-mobile-fixed="1"]').length > 0 ? (requestAnimationFrame(kn), cancelAnimationFrame(bn.raf), d.removeClass("scrolled-down").removeClass("detached").removeClass("invisible").removeClass("at-top").css("transform", "none")) : "true" == d.attr("data-transparent-header") && d.addClass("transparent"), s.off("smartresize.nectarNavScrollEffects"), s.on("smartresize.nectarNavScrollEffects", Tn))
    }

    function Tn() {
        bt.winW < 1e3 || (1 == k && "1" != I ? (s.off("scroll.headerResizeEffect"), 0 == t("#nectar_fullscreen_rows").length ? s.on("scroll.headerResizeEffect", yn) : t('#nectar_fullscreen_rows[data-mobile-disable="on"]').length > 0 && bt.usingMobileBrowser && s.on("scroll.headerResizeEffect", yn)) : "1" != I ? (s.off("scroll.headerResizeEffectOpaque"), s.on("scroll.headerResizeEffectOpaque", Cn)) : "1" == I && (t(".nectar-box-roll").length > 0 && d.addClass("at-top-before-box"), 0 == t('#header-outer[data-remove-fixed="1"]').length ? (cancelAnimationFrame(bn.raf), wn()) : (cancelAnimationFrame(bn.raf), bn.timeoutQueued = !0, "true" == d.attr("data-transparent-header") && 0 == t('body.material #header-outer[data-condense="true"]').length && d.hasClass("detached") && d.addClass("transparent"), d.removeClass("scrolled-down").removeClass("detached").removeClass("invisible").removeClass("at-top").css("transform", "none"))), t('#header-outer[data-format="centered-menu-bottom-bar"][data-condense="true"]').length > 0 && (c.length > 0 && d.css("transform", ""), bt.scrollTop > 200 && !d.hasClass("fixed-menu") && d.addClass("fixed-menu")), s.off("smartresize.nectarNavScrollEffects"), s.on("smartresize.nectarNavScrollEffects", $n))
    }

    function In() {
        if (t(".mobile").length > 0) bt.winH < bt.winW && bt.winW > 1e3 ? 0 == t("#header-outer.small-nav").length && t("#header-space").css("height", d.outerHeight()).addClass("calculated") : t("#header-space").css("height", d.outerHeight()).addClass("calculated");
    ...
    function En() {
        ...
        function o() {
            var e = 0;
            if (bt.winW < 1e3 || 1 == C && "none" == t("#header-outer .span_9").css("display") || 1 == C && "none" == t("#header-outer .span_9 > nav").css("display")) {
                e = 0;
                var a = "fixed" == u.css("position") ? u.height() : 0;
                (e += bt.adminBarHeight) - n > a ? d.css("top", e - n + "px") : d.css("top", a)
            } else 0 == C && (e = 0, d.is('[data-remove-fixed="1"]') || (e += bt.adminBarHeight), d.css("top", e + "px"))
        }
        ...
        t('#header-outer[data-mobile-fixed="1"]').length > 0 && u.length > 0 && (0 == t("#nectar_fullscreen_rows").length ? requestAnimationFrame(i) : t("#nectar_fullscreen_rows").length > 0 && bt.usingMobileBrowser && requestAnimationFrame(i), s.on("smartresize", o)), W && (0 == t("#nectar_fullscreen_rows").length && requestAnimationFrame(function t() {
            if (r.hasClass("compose-mode")) return;
            if (0 == B && bt.winW < 1e3) return requestAnimationFrame(t), d.css("margin-top", "0"), !1;
            n = bt.scrollTop;
    ...
    function On() {
        var e = 0,
            a = 0;
        if (d.is("[data-logo-height]") && d.is("[data-padding]") ? d.hasClass("transparent") || (e = "centered-menu-bottom-bar" == d.attr("data-format") && bt.winW > 1e3 ? d.outerHeight() : d.find("#logo.no-image").length > 0 ? "left-header" == T && bt.winW > 1e3 ? 0 : parseInt(d.find("#logo.no-image").height()) + parseInt(2 * d.attr("data-padding")) : "left-header" == T && bt.winW > 1e3 ? 0 : parseInt(d.attr("data-logo-height")) + parseInt(2 * d.attr("data-padding"))) : e = "left-header" == T && bt.winW > 1e3 ? 0 : d.outerHeight(), g.length > 0 && (a += g.height()), t(".page-header-no-bg").length > 0 && (a += t(".page-header-no-bg").height()), bt.winH - bt.adminBarHeight - e - bt.footerOuterHeight - 1 - a > 0) {
            ...
            t('body[data-footer-reveal="1"]:not(.nectar_using_pfsr) .container-wrap').css({
                "margin-bottom": bt.footerOuterHeight
            }), t(".container-wrap").css({
                "min-height": bt.winH - bt.adminBarHeight - e - bt.footerOuterHeight - a + n
            })
        } else t('body[data-footer-reveal="1"]:not(.nectar_using_pfsr) .container-wrap').css({
            "margin-bottom": bt.footerOuterHeight
        });
        bt.winW < 1e3 ? m.attr("data-midnight", "light") : m.removeAttr("data-midnight")
    }

    function zn() {
        (t('body[data-footer-reveal="1"]').length > 0 || t('body.material[data-slide-out-widget-area-style="slide-out-from-right"]').length > 0) && (setTimeout(On, 60), On(), s.on("resize", On), t('body[data-footer-reveal="1"][data-footer-reveal-shadow="large_2"]').length > 0 && t(".container-wrap").css({
            boxShadow: "0 70px 110px -30px " + m.css("backgroundColor")
        }))
    }

    function Hn(t) {
        this.$el = t, this.offsetTop = 0, this.fullHeight = 100, this.storedWinH = bt.winH, this.events(), this.calculate()
    }

    function Sn() {
        ct = [], t(".vc_row-o-full-height").each(function(e) {
            ct[e] = new Hn(t(this))
        })
    }
    ...
    function An() {
        ...
        }), (a > 0 || navigator.userAgent.match(/Trident.*rv\:11\./)) && (Mn(), t(e).on("resize", Mn))
    }
    ...
    function Wn() {
        t(".nectar-recent-posts-slider").each(function() {
            ...
            if (bt.winW > 1e3 && 0 == t("#boxed").length) 0 == t(this).parents(".full-width-content").length ? t('body[data-ext-responsive="true"]').length > 0 && bt.winW >= 1400 ? n.css("height", Math.ceil(e)) : 0 == t('body[data-ext-responsive="true"]').length && bt.winW >= 1100 ? n.css("height", Math.ceil(e)) : n.css("height", Math.ceil(e * a)) : n.css("height", Math.ceil(e * a));
            else {
    ...
    function Pn() {
        (t('.nectar-split-heading[data-animation-type="line-reveal-by-space"]').length > 0 || t('.nectar-split-heading[data-animation-type="letter-fade-reveal"]').length > 0) && (t('.nectar-split-heading[data-animation-type="line-reveal-by-space"]:not([data-text-effect="none"])').each(function() {
            ...
            if (t(this).is('[data-m-rm-animation="true"]') && bt.winW < 1e3) return !0;
    ...
    function jn() {
        if (t(".nectar-recent-posts-slider-inner").length > 0) {
            ...
            }), Wn(), s.on("resize", Wn), bt.usingMobileBrowser || bt.usingFrontEndEditor || s.on("resize", Rn)
        }
            ...
            P[e] = {
                ...
                if (!t(this).hasClass("active")) {
                    ...
                    clearTimeout(a), t(this).siblings().removeClass("active"), t(this).addClass("active"), a = setTimeout(function() {
                        ...
                        if (clearInterval(P[e].autorotate), t.attr("data-autorotate").length > 0) {
    ...
    function Vn() {
        t().flickity ? jn() : setTimeout(function() {
            jn()
        ...
        }), bt.usingMobileBrowser || t(".nectar-recent-posts-slider").length > 0 && !bt.usingFrontEndEditor && e.requestAnimationFrame(Yn), bt.usingMobileBrowser || bt.usingFrontEndEditor || Rn()
    }
    ...
    function Qn() {
        if (X = [], r.on("mouseenter", '.nectar_video_lightbox[data-parent-hover="1"]', function() {
                ...
                !bt.usingMobileBrowser && t(this).find(".play_button.follow_mouse").length > 0 && (X[e] = new Dn(t(this), ".play_button.follow_mouse .play"))
        ...
        t(".nectar-video-box").each(function(e) {
            if (t(this).find(".play_button_mouse_follow").length > 0) {
                ...
                t(this).imagesLoaded(function() {
                    bt.usingMobileBrowser || (X[e] = new Dn(a, ".play_button_mouse_follow"));
    ...
    function Gn() {
        U = [], "undefined" != typeof SalientRecentProjectsFullScreen && t(".nectar_fullscreen_zoom_recent_projects").each(function(e) {
    ...
    function Un() {
        t(".infinite_scroll").length > 0 && (t(".portfolio-items.infinite_scroll").infinitescroll({
            ...
            t(e).css("opacity", 0).imagesLoaded(function() {
                ...
                if (t(e).find(".work-item.style-5").length > 0 && Xn(), "none" == t(e).find(".inner-wrap").attr("data-animation")) t(".portfolio-items .col .inner-wrap").removeClass("animated");
                else {
                    for (i = 0; i < L.length; i++) L[i].masonryZindex(), L[i].portfolioAccentColor();
                    t(e).each(function() {
                ...
                t(".portfolio-items").each(function() {
                    ...
                    for (var a = 0; a < L.length; a++) L[a].masonryZindex(), L[a].reLayout(), L[a].isotopeCatSelection();
    ...
    function Jn() {
        bt.scrollTop > 350 && !o.is(".fullscreen.open") && (t("#to-top").stop().transition({
            transform: "translateY(-50%)"
        }, 350, "easeInOutCubic"), s.off("scroll", Jn), s.on("scroll", Kn))
    }
    ...
    function Kn() {
        if (bt.scrollTop < 350 || o.is(".fullscreen.open")) {
            ...
            }, e, "easeInOutQuint"), s.off("scroll", Kn), s.on("scroll", Jn)
        }
    }

    function ti() {
        if (0 == t(".nectar-social.fixed").length && (t("#to-top").length > 0 && bt.winW > 1020 || t("#to-top").length > 0 && t("#to-top.mobile-enabled").length > 0) && (bt.scrollTop > 350 ? s.on("scroll", Kn) : s.on("scroll", Jn)), t('body[data-button-style*="rounded"]').length > 0) {
    ...
    function ei() {
        ...
        t('header#top .sf-menu li a[href="#"]').on("click", function(t) {
            t.preventDefault()
        }), 0 == t("#nectar_fullscreen_rows").length || 0 == mt.$usingFullScreenRows ? t("a.nectar-next-section").each(function() {
    ...
    function ai() {
        ...
        if (n && (o = (o = n.split("/")).length), n && o > 1 && (n = n.replace(/\//g, ""), a = a.replace(/\//g, "")), a && t(".main-content").find(a).length > 0 || a && t(".main-content").find('[data-fullscreen-anchor-id="' + n + '"]').length > 0) {
            ...
            var u = 100;
            t(".nectar-box-roll").length > 0 && t(".container-wrap.bottomBoxOut").length > 0 && (gt.boxRoll(null, -1), u = 2050), t("img[data-nectar-img-src]").length > 0 && (oa(), u = 200), setTimeout(function() {
                var e;
                if (!0 === E) {
                    ...
                    if (r.hasClass("mobile")) e = t('#header-outer[data-mobile-fixed="1"]').length > 0 ? l.offset().top + 2 - h + bt.adminBarHeight : l.offset().top - bt.adminBarHeight + 1;
                    else {
                        var s = t('#header-outer[data-header-resize="0"]').length > 0 ? 0 : parseInt(_) + 2 * i;
                        if (t('#header-outer[data-remove-fixed="1"]').length > 0 && (h = 0), e = l.offset().top - parseInt(h) + s + 3 - bt.adminBarHeight, 0 == t("body.mobile").length && t('#header-outer[data-condense="true"]').length > 0 && 0 === t("body.page-template-template-no-header").length && 0 === t("body.page-template-template-no-header-footer").length) {
                ...
                t('body[data-hhun="1"]').length > 0 && 0 == t('#header-outer[data-remove-fixed="1"]').length && 0 == t("#header-outer.detached").length && (e += h), ee(e - (t('.page-submenu[data-sticky="true"]').length > 0 ? t(".page-submenu").height() : 0) + (t("body.material").length > 0 && c.length > 0 && 0 == t('body[data-hhun="1"]').length && 0 == t('#header-outer[data-remove-fixed="1"]').length && !r.hasClass("mobile") ? c.height() : 0), 0, "easeInOutQuint"), yt.animatedScrolling = !0, setTimeout(function() {
    ...
    function ni() {
        ...
        t(".portfolio-items:not(.carousel)").each(function(a) {
            if (t(this).attr("instance", a), t(this).parent().parent().find("div[class^=portfolio-filters]").attr("instance", a), "undefined" != typeof SalientPortfolio) L[e] = new SalientPortfolio(t(this), Ve, ht, Ae), e++;
            else {
                var n = t(this);
    ...
    function ii() {
        bt.winW > 690 && t('.posts-container[data-load-animation="perspective"]').css("perspective-origin", "50% " + (bt.scrollTop + bt.winH) + "px"), requestAnimationFrame(ii)
    }

    function si() {
        t('.posts-container[data-load-animation="perspective"]').length > 0 && requestAnimationFrame(ii)
    }
    ...
    function oi() {
        at = [], t(".posts-container").each(function(e) {
    ...
    function li() {
        ...
        if (t('#header-outer[data-remove-fixed="0"]').length > 0 && 0 == t('#header-outer[data-format="left-header"]').length) {
            ...
            if (0 == t("body.mobile").length && t('#header-outer[data-condense="true"]').length > 0) {
                ...
                e = 50, e += d.height() - (parseInt(n.position().top) - parseInt(t("#header-outer #logo").css("margin-top"))) - parseInt(bt.secondaryHeaderHeight)
            }
        }
    ...
    function di() {
        ...
        if (t(".nectar-sticky-column-css").each(function() {
                t(this).hasClass("n-sticky-initialized") || (0 == t(this).find(".n-sticky").length && t(this).wrapInner('<div class="n-sticky" />'), t(this).addClass("n-sticky-initialized"), t(this).hasClass("nectar-sticky-column-css--middle") && new _e(t(this)))
            }), t().theiaStickySidebar && !(bt.usingMobileBrowser && bt.winW < 1e3) && !(0 != mt.$usingFullScreenRows && bt.winW > 1e3)) {
    ...
    function ci() {
        ...
        for (var e = 0; e < K.length; e++) "displace-filter-fade" == K[e].animationType && t(K[e].canvasContainer).parents(".fp-section.active").length > 0 && (0 == t(K[e].canvasContainer).find(".image-added-to-stage").length && K[e].imgContainer.addChild(K[e].bg), t(K[e].canvasContainer).find(".nectar-liquid-bg").addClass("image-added-to-stage"), K[e].animateProps(K[e]))
    }
    ...
    function hi() {
        if (t("#nectar_fullscreen_rows").length > 0 && t().fullpage) {
            ...
            bt.usingMobileBrowser || (a = "off"), "on" != a ? ut = !0 : ht = "", "undefined" != typeof NectarFullScreenRows && (mt = new NectarFullScreenRows(rn, et, ci, bt, ia, nt, q, it))
    ...
    function ui() {
        ...
        }), bt.usingMobileBrowser && r.addClass("using-mobile-browser"), e.navigator.userAgent.indexOf("Edge/") > 0 && r.addClass("msie"), 0 == t("html.js").length && t("html").removeClass("no-js").addClass("js"), t("code").find("br").remove(), t(".wpcf7-form p:has(input[type=submit])").css("padding-bottom", "0px"), t(".full-width-content .wpcf7-submit").on("click", function() {
            setTimeout(function() {
                Ve()
    ...
    function fi() {
        var a = bt.winW,
            n = bt.winH,
            i = 0;
        r.is('[data-flex-cols="true"]') || t('[class*="vc_col-xs-"], [class*="vc_col-md-"], [class*="vc_col-lg-"]').length > 0 && (pi(), bt.usingMobileBrowser ? (e.addEventListener("orientationchange", function() {
            i = 1
        }), s.on("resize", function() {
            (s.width() != a && s.height != n || 1 === i) && (pi(), a = bt.winW, n = bt.winH, i = 0)
        })) : s.on("resize", pi))
    }
    ...
    function gi() {
        t('body[data-fancy-form-rcs="1"]').length > 0 && 0 == t("#wcfm-main-content").length && (t("select:not(.comment-form-rating #rating)").each(function() {
            var e;
            t(this).parents(".wpcf7-form-control-wrap").length > 0 ? 1 == (e = t(this).parents(".wpcf7-form-control-wrap").find(".select2-container").length > 0 ? t(t(this).prev(".select2-container")) : t(this)).parents(".wpcf7-form-control-wrap").parent().find("label").length ? e.parents(".wpcf7-form-control-wrap").parent().wrapInner('<div class="fancy-select-wrap" />') : e.wrap('<div class="fancy-select-wrap" />') : (e = t(this).prev(".select2-container").length > 0 ? t(this).prev(".select2-container") : t(this), 0 == t(this).parents("#buddypress").length && 0 == t(this).parents(".widget_categories").length && 0 == t(this).parents(".wc-blocks-components-select__container").length && (1 == e.prev("label").length ? e.prev("label").addBack().wrapAll('<div class="fancy-select-wrap" />') : 1 == e.next("label").length ? e.next("label").addBack().wrapAll('<div class="fancy-select-wrap" />') : e.wrap('<div class="fancy-select-wrap" />')))
        }), t("select:not(.state_select):not(.country_select):not(.comment-form-rating #rating):not(#tribe-bar-form select):not(.woocommerce-currency-switcher):not(.wc-blocks-components-select__container select):not(.nectar-custom-product-attr select):not(.flatpickr-calendar select)").each(function() {
    ...
    function mi() {
        (-1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome") || navigator.userAgent.match(/(iPod|iPhone|iPad)/)) && (e.onpageshow = function(e) {
            ...
            }, 100)) : t("#slide-out-widget-area.slide-out-from-right-hover.open").length > 0 && navigator.userAgent.match(/(iPod|iPhone|iPad)/) ? Ya() : (t("#slide-out-widget-area.fullscreen.open").length > 0 || t("#slide-out-widget-area.fullscreen-alt.open").length > 0 || t("#slide-out-widget-area.slide-out-from-right.open").length > 0) && (t("#slide-out-widget-area .slide_out_area_close").addClass("non-human-allowed"), t(".slide-out-widget-area-toggle:not(.std-menu) a.open").addClass("non-human-allowed").trigger("click"), setTimeout(function() {
                t("#slide-out-widget-area .slide_out_area_close").removeClass("non-human-allowed")
            }, 100)))
        })
    }
    ...
    function wi() {
        setTimeout(function() {
            t("body.compose-mode").length > 0 && t(".container-wrap").addClass("visible-editor-controls"), bt.usingFrontEndEditor && (vi(), r.is('[data-flex-cols="true"]') || (bi(), s.on("smartresize", bi)))
        }, 200), s.on("vc_reload", function() {
            if (vi(), Ie(), ke(), St(), Ye(), kt(), ye(), Ne(), ze(), Nn(), Ta(), Vt(), pa(), Pn(), Qn(), De(), ca(), t(".carousel").length > 0 && (Bt(), Yt(), jt()), t(".owl-carousel").length > 0 && (t(".owl-carousel").each(function() {
                ...
                }), Ft()), t(".nectar_cascading_images").length > 0 && imagesLoaded(t(".nectar_cascading_images"), function() {
                    Ze()
                }), Ae(), Re(), Vn(), t(".wpb_row.nectar-split-heading-merged").length > 0 && t(".wpb_row.nectar-split-heading-merged").removeClass("nectar-split-heading-merged"), j.length > 0)
                for (var a = 0; a < j.length; a++) j[a].instance.reloadCells(), j[a].instance.off("scroll.flickity"), j[a].instance.off("dragStart.flickity"), j[a].instance.off("dragEnd.flickity");
            if (It(), setTimeout(function() {
                    if (Et(), j.length > 0)
                        for (var t = 0; t < j.length; t++) j[t].instance.reloadCells(), j[t].instance.resize()
                }, 100), J.length > 0)
                for (a = 0; a < J.length; a++) J[a].instance.flickity("reloadCells"), J[a].instance.off("scroll.flickity"), J[a].instance.off("dragStart.flickity"), J[a].instance.off("dragEnd.flickity");
            setTimeout(function() {
                if (t(".nectar-woo-flickity").length > 0 && Pt(), J.length > 0)
                    for (var e = 0; e < J.length; e++) J[e].instance.flickity("reloadCells"), J[e].instance.flickity("resize")
            }, 100), ya();
            for (a = 0; a < tt.length; a++) "multiple_visible" != tt[a].type && "multiple_visible_minimal" != tt[a].type || (tt[a].flickityEl.flickity("reloadCells"), tt[a].flickityEl.off("select.flickity"), ya(), tt[a].flickityEl.resize()), tt[a].testimonialSliderHeight();
            if (_a(), wa(), $a(), he(), sa(), $e(), nn(), Ia(), Ea(), Ve(), setTimeout(Ve, 1e3), Ha(), Sn(), s.off("scroll.parallaxSections").off("resize.parallaxSections"), je(), qe(), oi(), ni(), L.length > 0)
                for (a = 0; a < L.length; a++) L[a].portfolioAccentColor();
            if (Xn(), Gn(), setTimeout(function() {
                    if (t(".nectar_fullscreen_zoom_recent_projects").length > 0 && U.length > 0)
                        for (var e = 0; e < U.length; e++) U[e].sliderCalcs()
                }, 300), s.unbind(".infscr"), Un(), Xe(), t(".nectar-video-wrap").each(function() {
            ...
            q = [], t(".svg-icon-holder").removeClass("animated-in").removeClass("bound"), t(".vc_nectar_gmap").length > 0 && setTimeout(function() {
            ...
            }, 100), di(), void 0 !== e.Waypoint && (Waypoint.destroyAll(), rn())
        })
    }

    function yi() {
        var a = !1;
        if (t('body[data-ajax-transitions="true"]').length > 0 && t('#ajax-loading-screen[data-disable-mobile="1"]').length > 0 && bt.winW < 1e3 && (a = !0), t('body[data-ajax-transitions="true"]').length > 0 && t('#ajax-loading-screen[data-method="standard"]').length > 0 && 0 == a) {
        ...
        bt.usingMobileBrowser && bt.scrollPosRAF(), ha(),
            function() {
                ...
                if (Wt(), 0 != t('body[data-header-format="left-header"]').length || bt.usingPhoneBrowser || (n = !(t('#header-outer[data-megamenu-rt="1"]').length > 0 && t('#header-outer[data-transparent-header="true"]').length > 0), e.nectarOptions && e.nectarOptions.dropdown_hover_intent && "add" === e.nectarOptions.dropdown_hover_intent && (n = !1), t(".sf-menu:not(.buttons)").superfish({
                    ...
                    }), t('body[data-megamenu-width="full-width"]').length > 0 && t("ul.sub-menu").length > 0 && (Mt(), s.on("smartresize", Mt), t("header#top nav > ul > li.megamenu > .sub-menu, header#top nav > ul > li.megamenu > .nectar-global-section-megamenu").css("box-sizing", "content-box")), t("header#top nav > ul.sf-menu > li.menu-item").on("mouseenter", function() {
            ...
            function() {
                e.nectarOptions && e.nectarOptions.quick_search && "true" === e.nectarOptions.quick_search && new pn;
                ...
                function i() {
                    if (r.hasClass("ascend") || t('body[data-header-format="left-header"]').length > 0 && 0 == t("body.material").length ? (t("#search-outer").stop().transition({
                        ...
                        }, a), t("#ajax-content-wrap").removeClass("material-open"), yt.materialSearchOpen = !1, d.removeClass("material-search-open"), t("#search-outer").removeClass("material-open"), t("#fp-nav").removeClass("material-ocm-open")
                    }
                }
            ...
            }(), 0 == t('#header-outer[data-remove-fixed="1"]').length && bt.winW > 1e3 && 0 != t(e).scrollTop() && 1 == t('#header-outer.transparent[data-permanent-transparent="false"]').length && d.removeClass("transparent"), bt.winW < 1e3 ? (0 == t(".nectar-box-roll").length || "1" == I && 0 == t('#header-outer[data-remove-fixed="1"]').length) && ($n(), s.on("smartresize.nectarNavScrollEffects", $n)) : (Tn(), s.on("smartresize.nectarNavScrollEffects", Tn)), di(), _a(), Ie(), i = t("#top #mobile-menu").length > 0 ? "#top #mobile-menu " : ".off-canvas-menu-container.mobile-only ", t(i + ".menu-item > ul > li > a").each(function() {
            ...
            }), Qa(), Aa(), "separate-dropdown-parent-link" == (t("#slide-out-widget-area[data-dropdown-func]").length > 0 ? o.attr("data-dropdown-func") : "default") && t("#slide-out-widget-area .off-canvas-menu-container li.menu-item-has-children").append('<span class="ocm-dropdown-arrow"><i class="fa fa-angle-down"></i></span>'),
            function() {
            ...
            }), qe(), he(), Un(), ti(), g = y - y / 1.8, r.on("click", ".section-down-arrow, .scroll-down-wrap > .minimal-arrow", function() {
                ...
                if (t("body.material").length > 0 && c.length > 0 && (l = c.height()), 0 == t('body[data-permanent-transparent="1"]').length)
                    if (r.hasClass("mobile")) ee((t('#header-outer[data-mobile-fixed="1"]').length > 0 ? parseInt(a) - o + parseInt(e.offset().top) + 2 : parseInt(a) + parseInt(e.offset().top) + 2) - 2 * i, 0, "easeInOutQuint");
                    else if (t('body[data-hhun="1"]').length > 0 && 0 == t('#header-outer[data-remove-fixed="1"]').length) ee(parseInt(a) + n + 2 - 2 * i, 0, "easeInOutQuint");
                else {
                    ...
                    if (t('#header-outer[data-remove-fixed="1"]').length > 0 && (o = 0, n = 0), 0 == t("body.mobile").length && t('#header-outer[data-condense="true"]').length > 0) {
                        ...
                        o = d.height() - (parseInt(u.position().top) - parseInt(t("#header-outer #logo").css("margin-top"))) - parseInt(bt.secondaryHeaderHeight)
                    }
                    ee(parseInt(a - o) + h + 3 + n + l, 0, "easeInOutQuint")
                } else ee(parseInt(a) + parseInt(e.offset().top) + 2 - 2 * i, 0, "easeInOutQuint");
                return !1
            }),
            function() {
                if (H && r.on("click", '#header-outer nav .sf-menu li:not(.slide-out-widget-area-toggle) a[href*="#"]', function() {
                        yt.ocmOpen && "#" != t(this).attr("href") && Za(t(this).parent())
                    }), t('body[data-animated-anchors="true"]').length > 0 || t('.single-product [data-gallery-style="left_thumb_sticky"]').length > 0) {
                    var a, n = y - y / 1.8;
                    setTimeout(ei, 100), r.on("click", '#header-outer nav .sf-menu a:not([href="#slide-out-widget-area"]), #header-outer .mobile-header .sf-menu a, #footer-outer .nectar-button, #footer-outer .widget_nav_menu a, #footer-widgets .textwidget a, #mobile-menu li a, .nectar-scrolling-tabs:not(.navigation_func_active_link_only) .scrolling-tab-nav a, .container-wrap a:not(.wpb_tabs_nav a):not(.navigation_func_active_link_only .scrolling-tab-nav a):not(.comment-wrap .navigation a):not(.woocommerce-checkout a):not(.um-woo-view-order):not(.magnific):not([data-fancybox]):not(.woocommerce-tabs .tabs a):not(.slider-prev):not(.slider-next):not(.testimonial-next-prev a):not(.page-numbers), .swiper-slide .button a, #slide-out-widget-area a, #slide-out-widget-area .inner div a', function(i) {
                        var o = !0,
                            l = t(this).prop("hash");
                        l && !t(this).hasClass("nectar-next-section") && 0 == t(this).parents(".slide-out-widget-area-toggle").length && (r.addClass("animated-scrolling"), yt.animatedScrolling = !0), clearTimeout(a), a = setTimeout(function() {
                            r.removeClass("animated-scrolling"), yt.animatedScrolling = !1
                        }, 1100);
                        ...
                        if ((t(".page-template-template-no-header-footer").length > 0 || t(".page-template-template-no-header").length > 0 || 0 == t("#header-space").length) && (h = 0), 0 != mt.$usingFullScreenRows && t('#nectar_fullscreen_rows[data-anchors="on"]').length > 0 && l && "" != l && "#top" != l && t('body.material[data-slide-out-widget-area-style="slide-out-from-right"].material-ocm-open').length > 0 && (i.preventDefault(), t(this).hasClass("skip-hash") || (history.pushState ? history.pushState(null, null, l) : location.hash = l), setTimeout(function() {
                            ...
                            var p = 1,
                                f = t(this);
                            t(".nectar-box-roll").length > 0 && t(".container-wrap.bottomBoxOut").length > 0 && (gt.boxRoll(null, -1), p = 2050), t("img[data-nectar-img-src]").length > 0 && (oa(), p = 200), setTimeout(function() {
                                var e;
                                if (!0 === E) {
                                    var a = t("#header-outer").outerHeight() + 2 * parseInt(t("#header-outer").css("margin-top"));
                                    e = t(l).offset().top - a - bt.adminBarHeight
                                } else if (0 == t('body[data-permanent-transparent="1"]').length)
                                    if (r.hasClass("mobile")) e = t('#header-outer[data-mobile-fixed="1"]').length > 0 ? t(l).offset().top + 2 - h + bt.adminBarHeight : t(l).offset().top - bt.adminBarHeight + 1;
                                    else {
                                        var i = t('#header-outer[data-header-resize="0"]').length > 0 ? 0 : parseInt(_) + 2 * n;
                                        if (t('#header-outer[data-remove-fixed="1"]').length > 0 && (h = 0), e = t(l).offset().top - parseInt(h) + i + 3 - bt.adminBarHeight, 0 == t("body.mobile").length && 0 === t("body.page-template-template-no-header").length && 0 === t("body.page-template-template-no-header-footer").length && t('#header-outer[data-condense="true"]').length > 0) {
                                            ...
                                            e = t(l).offset().top - parseInt(h) + u - bt.adminBarHeight
                                        }
                                    }
                                ...
                                p = t("body.material").length > 0 && c.length > 0 && 0 == t('body[data-hhun="1"]').length && 0 == t('#header-outer[data-remove-fixed="1"]').length && !r.hasClass("mobile") ? c.height() : t('body[data-hhun="1"]').length > 0 && c.length > 0 && !r.hasClass("mobile") && 0 == t('#header-outer[data-remove-fixed="1"]').length ? c.height() : 0, o && ee(e - g + p, 0, "easeInOutQuint")
                            }, p), i.preventDefault()
                        }
    ...
    function Ci() {
        0 == t(e).scrollTop() && In(), t("video").css("visibility", "visible"), t('body[data-animated-anchors="true"]').length > 0 && (0 == t(".nectar-box-roll").length && 0 == t("#nectar_fullscreen_rows").length && (void 0 !== re.tab ? setTimeout(function() {
            ai()
        }, 800) : ai()), t('#nectar_fullscreen_rows[data-mobile-disable="on"]').length > 0 && 0 == t(".nectar-box-roll").length && bt.usingMobileBrowser && ai()), Ve(), bt.usingMobileBrowser || Ye()
    }
    Hn.prototype.events = function() {
        ...
        this.offsetTop = this.$el.offset().top, this.offsetTop < this.storedWinH && this.$el.hasClass("top-level") && !bt.usingFrontEndEditor || (this.$el.css("min-height", this.storedWinH), this.$el.find("> .col.span_12").css("min-height", this.storedWinH))
        ...
        a.$el.hasClass("play_button_hover") && (a.hoverOnly = !0), a.$el.on("mouseenter", function(t) {
            ...
            1 == a.activeFollow && 0 == a.lastScroll && (a.lastScroll = bt.scrollTop)
        })
    }, Dn.prototype.rafLoop = function() {
        1 == this.activeFollow ? (this.scrollAdjust = 0, this.alteredY = this.elY, this.lastScroll > 0 && (this.scrollAdjust = bt.scrollTop - this.lastScroll, this.alteredY += this.scrollAdjust), this.lastY = Dt(this.lastY, this.alteredY, this.percentage), this.lastX = Dt(this.lastX, this.elX, this.percentage), this.lastY2 = Dt(this.lastY2, this.alteredY, this.percentage), this.innerLastX = Dt(this.innerLastX, parseInt(this.elX) - parseInt(this.lastX), this.percentage) / 1.7, this.innerLastY = Dt(this.innerLastY, parseInt(this.alteredY) - parseInt(this.lastY2), this.percentage) / 1.7) : (this.lastY = Dt(this.lastY, this.initialY, .055), this.lastX = Dt(this.lastX, this.initialX, .055), this.innerLastX = 0, this.innerLastY = 0), this.$iconEl[0].style.transform = "translateX(" + this.lastX + "px) translateY(" + this.lastY + "px)", this.$innerIconEl.length > 0 && (this.$innerIconEl[0].style.transform = "translateX(" + Nt(this.innerLastX, 14, -14) + "px) translateY(" + Nt(this.innerLastY, 14, -14) + "px)"), requestAnimationFrame(this.rafLoop.bind(this))
    }, jQuery(a).ready(function(t) {
        bt.usingFrontEndEditor = void 0 !== e.vc_iframe, sn(), hi(), ca(), fn(), mn(), vn(), En(), on(), fi(), Ae(), Re(), Se(), Me(), Ve(), Ta(), An(), Sn(), je(), Ye(), Oa(), Ia(), Ea(), Ha(), Sa(), tn(), zn(), hn(), gi(), si(), _i(), new Jt, ui(), mi(), wi(), yi(), s.off("smartresize.srInit"), s.on("smartresize.srInit", _t), s.off("resize.srInit"), s.on("resize.srInit", xt), e.addEventListener("orientationchange", Ct), "complete" === a.readyState && Ci(), s.on("load", Ci)
    })
